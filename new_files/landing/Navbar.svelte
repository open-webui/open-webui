...
<div class="fixed w-full z-50">
	<div class="container mx-auto px-4 max-w-[1440px]">
		...
		>
			<a
				href="/"
				class="logo font-Inter hover:scale-110 transition-all px-6 py-2 rounded-md flex items-center justify-center mt-6 bg-[var(--surface-primary)]"
			>
				<h1
			...
			<div class="flex items-center gap-[30px]">
				<div class="social flex items-center gap-5">
					...
					>
						<img
							src="/src/lib/assets/icons/medium.svg"
							height={16}
							width={16}
							alt="Medium"
					...
					>
						<img
							src="/src/lib/assets/icons/linkedin.svg"
							height={16}
							width={16}
							alt="LinkedIn"
							class="w-4 h-4 {isDark ? 'invert' : ''}"
