...
usage() {
    ...
    echo "  $0 --enable-gpu[count=1] --enable-api[port=12345] --webui[port=3000] --ollama-data[folder=./ollama-data]"
    echo "  $0 --enable-gpu[count=1] --enable-api[port=12345] --webui[port=3000] --ollama-data[folder=./ollama-data] --webui-data[folder=./webui-data] --build"
    echo ""
