"""
title: Nidum — Fonte e Convergências (engine determinístico)
author: Nidum
version: 0.6.0
description: Engine determinístico em 3 camadas — FONTE (roster + listas canônicas: 13 etapas, 5 princípios, 4 valores, régua), CONVERGÊNCIAS (estado vigente de cada ecossistema, sem precisar de data) e etiqueta de certeza. Dados embutidos.
"""
