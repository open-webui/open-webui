...
- 🎨 **Multi-model responses scroll.** The multi-model responses tab list now supports horizontal scrolling on desktop, making all models accessible when the list exceeds the screen width. [#21800](https://github.com/open-webui/open-webui/issues/21800)
