...
- 🌐 **Updated translations.** Spanish (es-ES) translations were updated. [#25836](https://github.com/open-webui/open-webui/pull/25836)
...
- 💽 **Settings no longer lost after a restart.** Admin configuration is now stored more reliably, fixing cases where external connections and model parameters could be lost after restarting the server. [Commit](https://github.com/open-webui/open-webui/commit/5cdcdbaeec9fc8156721c38c33ec37956962871c), [#24743](https://github.com/open-webui/open-webui/issues/24743), [#25911](https://github.com/open-webui/open-webui/pull/25911), [#25959](https://github.com/open-webui/open-webui/pull/25959)
...
- 🎚️ **Default model parameters apply to requests.** Default model parameters are now applied to outbound requests, so settings like temperature take effect as configured. [Commit](https://github.com/open-webui/open-webui/commit/cd6cc39c6d), [#24930](https://github.com/open-webui/open-webui/issues/24930)
