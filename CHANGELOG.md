...
- 🔌 API endpoints now support independent access control updates for models and tools, enabling finer-grained permission management. [Commit](https://github.com/open-webui/open-webui/commit/0044902c082f8475336cc7d5c57fe3f35ab0555d)
- 📚 API endpoints now support independent access control updates for knowledge bases, enabling finer-grained permission management. [Commit](https://github.com/open-webui/open-webui/commit/c259c878060af1b03b702c943e8813d7b4fc3199)
- 📝 API endpoints now support independent access control updates for notes, enabling finer-grained permission management. [Commit](https://github.com/open-webui/open-webui/commit/e3a825769063cee486650cc2eb9a032676e630c5)
...
- 🛠️ Updating model write permissions no longer incorrectly overwrites access permissions, fixing permission management in the admin panel. [Commit](https://github.com/open-webui/open-webui/commit/4aedfdc5471a1f13c1084b34b48ea3ed6311cd42)
