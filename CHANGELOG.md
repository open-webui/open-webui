...
- 🔌 **Backend outlet filters for API proxy.** Pipeline and function outlet filters now run in backend completion flows for persisted and temporary local chats, and API callers without chat context can enable reliable outlet processing by providing or synthesizing correlation metadata as documented in the filter function guide. [#3237](https://github.com/open-webui/open-webui/issues/3237), [Commit](https://github.com/open-webui/open-webui/commit/cf4218e688def6f11d195aeda6665ae5b5376b67), [Docs](https://docs.openwebui.com/features/extensibility/plugin/functions/filter)
