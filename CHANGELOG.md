...
- 🐛 Sidebar no longer auto-reopens on desktop after a user closes it; the UI now respects the user's preference when switching between mobile and desktop views. [#18149](https://github.com/open-webui/open-webui/issues/18149)
