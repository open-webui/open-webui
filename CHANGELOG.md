...
- 🧩 **Custom API key header.** Administrators can now set "CUSTOM_API_KEY_HEADER" so API keys can be accepted from a custom header when reverse proxies already use the Authorization header. [Commit](https://github.com/open-webui/open-webui/commit/db05fdaf8366d327dbe33550aa917dea1f4c0e16)
...
- 🔊 **Notification sound toggle.** Notification sounds now stay off when the main "Notification Sound" setting is disabled, even if "notificationSoundAlways" is enabled. [#23941](https://github.com/open-webui/open-webui/issues/23941), [Commit](https://github.com/open-webui/open-webui/commit/3e14524154c7eb1a53d015d67eab4cb199cbe511)
- 🔎 **Firecrawl web search recovery.** Web search with Firecrawl now works again without failing from a missing request dependency during page extraction. [#23966](https://github.com/open-webui/open-webui/issues/23966), [#24012](https://github.com/open-webui/open-webui/pull/24012), [Commit](https://github.com/open-webui/open-webui/commit/0e311a95a7ba953aceaa1eac3525af83fe2fb980)
- 🪟 **Windows startup wildcard handling.** Starting on Windows no longer fails when forwarded IP settings default to a wildcard value. [#23989](https://github.com/open-webui/open-webui/issues/23989), [#23991](https://github.com/open-webui/open-webui/pull/23991), [Commit](https://github.com/open-webui/open-webui/commit/a76a779c01e2e9106eacf141424b28fa870cb21e)
- 🧠 **Mistral TTS request handling.** Mistral text-to-speech configuration now handles voice and model lookups more reliably to prevent failed playback requests. [#24021](https://github.com/open-webui/open-webui/issues/24021), [#24051](https://github.com/open-webui/open-webui/issues/24051), [Commit](https://github.com/open-webui/open-webui/commit/d0e51bde5d23a23c8bcfe526bf2f6f4aca0ac557)
- 🔌 **Tool call context persistence.** Follow-up tool calls now keep required metadata across streaming cycles so integrations continue working after prior tool use. [#23988](https://github.com/open-webui/open-webui/issues/23988), [Commit](https://github.com/open-webui/open-webui/commit/5cc55e227815dbb9c466243f16d8358cfd845d82), [Commit](https://github.com/open-webui/open-webui/commit/90584ab6f317ea71719dc0a5dfce8a2418f17fb6), [Commit](https://github.com/open-webui/open-webui/commit/b87c7555740dc87c69eea9704750bbbfdcb3db0f)
- 🧰 **Automation model detection.** Creating automations from chat now correctly detects the active model instead of failing with model detection errors. [#23943](https://github.com/open-webui/open-webui/issues/23943), [Commit](https://github.com/open-webui/open-webui/commit/a76652193385fe248425956d3075119f4e5bfbbf)
- 📡 **Proxy streaming header cleanup.** Streaming API clients no longer fail decompression because stale upstream encoding headers are removed before responses are forwarded. [#23920](https://github.com/open-webui/open-webui/issues/23920), [Commit](https://github.com/open-webui/open-webui/commit/7da6b82471f0867450f622eb12e01637655c8e7f)
- 🧪 **Ollama stream compatibility.** Ollama streaming responses now use stable completion IDs and include assistant role initialization for better OpenAI-compatible client support. [#23922](https://github.com/open-webui/open-webui/issues/23922), [Commit](https://github.com/open-webui/open-webui/commit/d6b73ea2f2951a48e8a422e27fc6d3e53371cc17)
- 🎯 **Skill mention injection in persisted chats.** Skill mentions added in normal saved chats are now detected and injected correctly instead of being skipped. [#23950](https://github.com/open-webui/open-webui/issues/23950), [Commit](https://github.com/open-webui/open-webui/commit/d8b55afb00ee308bdfd482e39728e1401d2f2911)
- 🔐 **Docling SSL setting support.** Docling extraction requests now honor "AIOHTTP_CLIENT_SESSION_SSL" so self-signed deployments can work as configured. [#24073](https://github.com/open-webui/open-webui/issues/24073), [Commit](https://github.com/open-webui/open-webui/commit/60f67c7c17e65d0989a4bc3f1eb283feeddb76ad)
...
- 🔑 **Brotli packaging consistency.** Package installations now include consistent Brotli support across dependency surfaces to prevent compressed response decoding failures in some environments. [#23956](https://github.com/open-webui/open-webui/pull/23956), [Commit](https://github.com/open-webui/open-webui/commit/89669f3fa1a75ca2b38afe4dd345ae97132af302), [Commit](https://github.com/open-webui/open-webui/commit/752238247c251cd0bd974b25beee69112939b101)
