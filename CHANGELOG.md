...
- 📋 Chat file associations are now properly tracked in the database through a new "chat_file" table, enabling accurate file management across chats, improved performance for shared chats by associating files with specific messages rather than embedding them in message data, and ensuring file visibility is correctly maintained in multi-node deployments. [Commit](https://github.com/open-webui/open-webui/commit/f1bf4f20c53e6493f0eb6fa2f12cb84c2d22da52)
...
- 🖼️ Shared chats with images no longer show broken images to other users; image visibility is now correctly maintained when accessing shared chat links created with generated or edited images. [Commit](https://github.com/open-webui/open-webui/commit/45e323775606e9e38710c11df6710edc8d3b8ebe), [#19393](https://github.com/open-webui/open-webui/issues/19393)
