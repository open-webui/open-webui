...
- 🧮 **Correct Handling for Milvus Index Type in Standalone Mode**: Search and indexing now work seamlessly in all Milvus environments, whether running as a standalone instance or clustered.
