...
- 🔌 **Backend outlet filters for API proxy.** Pipeline and function outlet filters now run directly in backend chat completion flows, so API proxy clients receive post-processed responses consistently without requiring a separate completion callback. [#3237](https://github.com/open-webui/open-webui/issues/3237), [Commit](https://github.com/open-webui/open-webui/commit/cf4218e688def6f11d195aeda6665ae5b5376b67)
