...
- 🔱 **Terminal server orchestrator support.** Terminal servers can now route through orchestrator policy endpoints, enabling integration with orchestrator-managed deployments. [Commit](https://github.com/open-webui/open-webui/commit/d85b52bfc24f3e99125c62a5df82869933f9c3cc)
...
- 🔗 **Multi-system message merging.** Models with strict chat templates like Qwen no longer fail when multiple pipeline stages inject separate system messages, as all system messages are now merged into one at the start. [Commit](https://github.com/open-webui/open-webui/commit/631bd20c3537ce85bbaec02f9e0049c88fa8fdd4)
