...
- 📚 Uploading files to knowledge bases now works correctly after a regression in the dev branch that caused database mapping errors. [#20925](https://github.com/open-webui/open-webui/issues/20925), [#20931](https://github.com/open-webui/open-webui/pull/20931)
