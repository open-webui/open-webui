...
- 📊 Administrators now have access to an Analytics dashboard showing model usage statistics, token consumption by model and user, user activity rankings, and time-series charts with hourly or daily granularity, with all historical chat data automatically migrated during upgrade. [#21106](https://github.com/open-webui/open-webui/pull/21106)
