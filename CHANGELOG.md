...
- **🌐 Notification Webhook Integration**: Get alert notifications via webhooks even when your tab is fully closed! Perfect for timely updates in long-running chats, streamlining external integrations.
