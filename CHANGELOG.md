...
- 🌿 **Fork a chat.** Typing a fork command in the message input makes a full copy of the conversation as a new chat, so you can carry on from it without touching the original. [Commit](https://github.com/open-webui/open-webui/commit/63ada247066dfc51e0e9559366f0cfd9a98db40b)
...
- ↕️ **Sort your notes.** The notes list can now be sorted by title or by when it was last updated, in either direction, by clicking the column headings. [Commit](https://github.com/open-webui/open-webui/commit/30c91e46e5d237bee3c8805bd54749408cc2727a)
