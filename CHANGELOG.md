...
- 🧩 **New plugin primitive — the Event function.** Joining pipe, filter, and action, the new Event function lets you run your own Python in response to system events across the whole application — from sign-ups and chats to configuration changes and startup — opening the door to custom onboarding, access control, auditing, automation, and integrations, all from inside Open WebUI. Comes with starter boilerplate in the function editor. [Commit](https://github.com/open-webui/open-webui/commit/e124c2656a4c2092b070e570e35b2f0fb7f584de), [Docs](https://docs.openwebui.com/features/extensibility/plugin/functions/event)
