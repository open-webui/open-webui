...
- 🌐 **Translation updates.** Translations for Spanish (Spain), Swedish, German, Korean, and Catalan were enhanced and expanded.
...
- 🔍 **Web search reliability.** Web search again fetches page content reliably with the default web loader engine, and a new "USER_AGENT" environment variable lets administrators set a real browser user-agent so fetches aren't blocked by Cloudflare, Wikipedia, and other bot-detection systems. [#24560](https://github.com/open-webui/open-webui/issues/24560), [Commit](https://github.com/open-webui/open-webui/commit/f60733758272c4532cd032e518c9cd73f648043a)
