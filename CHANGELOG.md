...
- 🔤 **Non-UTF-8 text and CSV uploads.** Text and CSV files saved in legacy encodings such as Latin-1 or Windows-1252 are now recognized and loaded correctly instead of being rejected as binary or failing to process. [#25172](https://github.com/open-webui/open-webui/issues/25172), [Commit](https://github.com/open-webui/open-webui/commit/6f0277db52d005420480abb0702d421525d6ea8b)
