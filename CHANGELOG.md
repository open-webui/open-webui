...
- 🧩 **New plugin primitive — the Event function.** A new Event function joins pipe, filter, and action as a function primitive, letting you run custom logic in response to system events, with starter boilerplate in the function editor. [Commit](https://github.com/open-webui/open-webui/commit/e124c2656a4c2092b070e570e35b2f0fb7f584de)
