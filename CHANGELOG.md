...
- 🌿 **Fork a chat.** Typing a fork command in the message input branches the conversation into a new chat from where you are, leaving the original untouched so you can try a different direction. [Commit](https://github.com/open-webui/open-webui/commit/75894161e46aafe30a7db4ecc946af60f04495e4)
