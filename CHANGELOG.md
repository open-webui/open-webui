...
- 🔐 **Logout Not Working with OAuth**: When OAuth was configured via the `GOOGLE_`, `MICROSOFT_` or `GITHUB_` variables without the `OPENID_PROVIDER_URL` set, the logout was not working.
