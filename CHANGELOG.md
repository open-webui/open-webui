...
- 💬 Multiple critical chat stability errors have been resolved, including duplicate key errors from circular message dependencies, null message access during chat loading, and errors in the chat overview visualization. [#20268](https://github.com/open-webui/open-webui/pull/20268)
...
- 🔧 Fixed SyntaxWarning for invalid escape sequences in password validation regex patterns by converting to raw strings. [#20298](https://github.com/open-webui/open-webui/pull/20298), [Commit](https://github.com/open-webui/open-webui/commit/e55bf2c2ac391caed871d41f0484820091081908)
...
- 📄 Document chunking now uses a two-stage approach where markdown header splitting is applied first as a preprocessing step, followed by character or token splitting. The standalone "Markdown (Header)" text splitter option has been removed from the TEXT_SPLITTER dropdown. Users who previously used TEXT_SPLITTER="markdown_header" should switch to "character" or "token" and ensure the new "ENABLE_MARKDOWN_HEADER_TEXT_SPLITTER" toggle is enabled. [Commit](https://github.com/open-webui/open-webui/commit/d3a682759f375c6cb0bc8c170f62863a070f712e), [Commit](https://github.com/open-webui/open-webui/commit/18a33a079bf07487edffc421a721c86194cc90c9), [Commit](https://github.com/open-webui/open-webui/commit/08bf4670ec862018f9dc57296cb19fd5eab14ef6)
