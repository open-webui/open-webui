...
- 📝 Source-level log environment variables (AUDIO_LOG_LEVEL, COMFYUI_LOG_LEVEL, CONFIG_LOG_LEVEL, DB_LOG_LEVEL, IMAGES_LOG_LEVEL, MAIN_LOG_LEVEL, MODELS_LOG_LEVEL, OLLAMA_LOG_LEVEL, OPENAI_LOG_LEVEL, RAG_LOG_LEVEL, WEBHOOK_LOG_LEVEL, SOCKET_LOG_LEVEL, OAUTH_LOG_LEVEL) were removed; users should use GLOBAL_LOG_LEVEL exclusively for logging configuration. [#20045](https://github.com/open-webui/open-webui/pull/20045)
