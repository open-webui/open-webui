...
- 📊 Exporting tables to CSV now properly displays special characters instead of HTML entities like "&amp;" and "&quot;". [#20688](https://github.com/open-webui/open-webui/pull/20688)
