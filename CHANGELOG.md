...
- 💬 Channels now include a clickable user count that opens a modal displaying all users with access, featuring search, sorting, and pagination capabilities. [Commit](https://github.com/open-webui/open-webui/commit/c0e120353824be00a2ef63cbde8be5d625bd6fd0)
