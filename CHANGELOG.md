...
- 🔐 Sharing resources with groups configured for member-only access no longer fails with database errors. [Commit](https://github.com/open-webui/open-webui/commit/5a075a2c836e46b83f8710285f09aff1f6125072)
