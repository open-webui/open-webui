...
- 🛠️ **Terminal file upload tool.** Open Terminal workflows can now upload files through a built-in tool, making file-based terminal tasks possible directly from chat. [Commit](https://github.com/open-webui/open-webui/commit/e709d6812f7fba246c4b7907f9fa41f751717566), [#23349](https://github.com/open-webui/open-webui/pull/23349)
