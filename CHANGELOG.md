...
- ⚡ **Faster password hashing and bulk user import.** Password hashing no longer blocks the server, and importing users from a CSV is now processed in a single batch, keeping large imports responsive. [Commit](https://github.com/open-webui/open-webui/commit/6fdf9b4340), [#25804](https://github.com/open-webui/open-webui/pull/25804)
