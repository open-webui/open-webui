...
- ⚡ **Health check responsiveness.** Health and readiness probe routes now avoid blocking database calls in async handlers, improving responsiveness and reducing event-loop stalls during probe traffic. [#24380](https://github.com/open-webui/open-webui/pull/24380)
...
- 🎤 **Non-blocking STT processing.** Speech-to-text transcription no longer blocks the server event loop, so other users can continue using chats and live connections while long transcriptions run. [#24338](https://github.com/open-webui/open-webui/pull/24338), [#24169](https://github.com/open-webui/open-webui/issues/24169)
