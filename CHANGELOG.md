...
- 📅 **Calendar creation modal.** Users can now create calendars directly from a dedicated modal with name and color selection, making calendar setup quicker from the interface. [Commit](https://github.com/open-webui/open-webui/commit/34146ab60f5dc1a2f8bdda8e61ce02797233a25d)
...
- 📸 **Complete chat image capture.** Downloaded chat snapshots now include all messages more reliably by disabling deferred message visibility during capture. [Commit](https://github.com/open-webui/open-webui/commit/34146ab60f5dc1a2f8bdda8e61ce02797233a25d)
