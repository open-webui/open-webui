...
- ⚡ Chat overview component is now dynamically loaded on demand, reducing initial page bundle size by approximately 470KB and improving first-screen loading speed. [#17595](https://github.com/open-webui/open-webui/pull/17595), [Commit](https://github.com/open-webui/open-webui/commit/b4536a6ff7e1ef5c8cb8e8c8e5e5e5e5e5e5e5e5)
...
- 🗄️ Redis session storage is now available as an experimental option for OAuth authentication flows via the ENABLE_STAR_SESSIONS_MIDDLEWARE environment variable, providing shared session state across multi-replica deployments to address CSRF errors, though currently only basic Redis setups are supported. [#17223](https://github.com/open-webui/open-webui/pull/17223), [#15373](https://github.com/open-webui/open-webui/issues/15373), [Commit](https://github.com/open-webui/open-webui/commit/861953ff7e1ef5c8cb8e8c8e5e5e5e5e5e5e5e5)
...
- 🔐 Login redirect now correctly honors the redirect query parameter after authentication, ensuring users are returned to their intended destination with query parameters intact instead of defaulting to the homepage. [#18071](https://github.com/open-webui/open-webui/issues/18071), [Commit](https://github.com/open-webui/open-webui/commit/db17806)
