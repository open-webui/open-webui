...
- 🧩 **Filter functions can post-process direct API responses.** Filter function outlets can now run for direct API callers, including streaming responses, so response post-processing isn't limited to the web interface; this is controlled by a new setting and on by default. [Commit](https://github.com/open-webui/open-webui/commit/390e200f76877b185002c88b4dda27b123d29e83), [#25650](https://github.com/open-webui/open-webui/pull/25650)
...
- 🖐️ **Drag items from the sidebar into chat.** Folders, notes, and models can now be dragged from the sidebar into the chat input. [#25771](https://github.com/open-webui/open-webui/pull/25771)
...
- ⚡ **Lighter file lists.** Listing and searching files no longer returns each file's full extracted text by default, making those requests much lighter for collections with large documents. [Commit](https://github.com/open-webui/open-webui/commit/36d08fa2a7), [Commit](https://github.com/open-webui/open-webui/commit/46c1d6591badb6ab567ba1b8fae23475d5da105a), [#25774](https://github.com/open-webui/open-webui/pull/25774), [#25741](https://github.com/open-webui/open-webui/issues/25741), [#26145](https://github.com/open-webui/open-webui/pull/26145)
...
- 🌐 **Updated translations.** Catalan, Brazilian Portuguese (pt-BR), Irish, and Spanish (es-ES) translations were updated.
...
- 🧷 **Damaged chat history recovers more reliably.** When a chat's current position is missing or malformed, Open WebUI now recovers it from the latest message instead of risking a broken history view. [Commit](https://github.com/open-webui/open-webui/commit/2308b59f135e4c2da11eabdf2306e55a5dd4e9fb)
...
- 🎛️ **Chat controls persist across navigation.** Edits to chat controls are now kept when navigating between chats instead of being lost. [#26336](https://github.com/open-webui/open-webui/pull/26336)
...
- 🧩 **MCP resource results come through.** Tool results that return resource content — including binary blobs and URI references — are no longer silently dropped. [#25260](https://github.com/open-webui/open-webui/pull/25260), [#24038](https://github.com/open-webui/open-webui/issues/24038)
