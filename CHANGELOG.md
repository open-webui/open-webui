...
- 🔧 In multi-worker deployments, uploading very large documents to knowledge bases no longer causes workers to be killed by health check timeouts. [#21158](https://github.com/open-webui/open-webui/pull/21158), [Discussion](https://github.com/open-webui/open-webui/discussions/21151)
