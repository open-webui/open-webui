...
- 🎥 **Video file uploads.** Video files can now be uploaded and are stored intact, making them available downstream for use with vision models and multimodal tools. [Commit](https://github.com/open-webui/open-webui/commit/42c86e7283a530e7cb8dfb2aba197cb0bef56f60)
...
- 🌐 **Translation updates.** Translations for Spanish (Spain), Swedish, and German were enhanced and expanded.
