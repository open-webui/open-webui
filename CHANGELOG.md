...
- ⚙️ **Terminal feature toggle.** Administrators can now enable or disable the Open Terminal feature via the OPEN_TERMINAL_ENABLE_TERMINAL environment variable, controlling access to terminal routes and the WebSocket endpoint. [Commit](https://github.com/open-webui/open-webui/commit/b5c3395f79bcc7ff5bc1d82bb86a60583bb3b5bd)
