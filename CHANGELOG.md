...
- 📃 **Legacy Word document support.** Older ".doc" Word files can now be uploaded and have their text extracted, in addition to the modern ".docx" format. [Commit](https://github.com/open-webui/open-webui/commit/9e3e24e304f8ff210494380b46f614a2984cafb3)
