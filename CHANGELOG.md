...
- 💨 Administrators can now enable KV prefix caching optimization for large documents by setting "RAG_SYSTEM_CONTEXT" to true, which injects knowledge base context into the system message instead of user messages, enabling instant follow-up questions on 100+ page documents by reusing cached tokens instead of reprocessing the entire document on each turn. [#20301](https://github.com/open-webui/open-webui/discussions/20301), [#20317](https://github.com/open-webui/open-webui/pull/20317)
