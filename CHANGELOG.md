...
- ♿ **Model selector accessibility improvements.** Improved screen reader support in the model selector with proper ARIA roles, dynamic labels, and contextual descriptions for better navigation. [#21706](https://github.com/open-webui/open-webui/pull/21706)
