...
## Unreleased
### Changed
- **Azure OpenAPI endpoint detection**: Relaxed criteria under which Azure OpenAPI endpoints are detecting when adding new connections. ([#15933](https://github.com/open-webui/open-webui/pull/15933))
