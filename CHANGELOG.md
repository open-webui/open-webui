...
- 🎫 MCP OAuth 2.1 token exchange failures are now fixed by removing duplicate credential passing that caused "ID1,ID1" concatenation and 401 errors, and multi-node deployments now properly propagate OAuth clients across cluster nodes through lazy-loading from Redis-synced configuration instead of relying on in-memory registration. [#20076](https://github.com/open-webui/open-webui/pull/20076), [#19823](https://github.com/open-webui/open-webui/issues/19823), [#19901](https://github.com/open-webui/open-webui/issues/19901)
