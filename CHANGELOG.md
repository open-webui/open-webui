...
- 👤 Resources can now be shared directly to individual users, not just groups. Knowledge bases, prompts, models, tools, channels, and even base models can now be granted access on a per-user basis alongside the existing per-group sharing functionality. [#21277](https://github.com/open-webui/open-webui/pull/21277)
