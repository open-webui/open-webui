...
- ☁️ **Azure responses support.** Azure OpenAI connections now work correctly with the newer "/openai/v1" base URL format, avoiding 404 errors and preserving the expected request path for chat, responses, and proxy calls. [#23484](https://github.com/open-webui/open-webui/pull/23484)
