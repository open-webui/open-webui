...
OLLAMA_MODEL_WEIGHTS = os.environ.get("OLLAMA_MODEL_WEIGHTS", "")
OLLAMA_MODEL_WEIGHTS = (
    OLLAMA_MODEL_WEIGHTS if OLLAMA_MODEL_WEIGHTS != "" else OLLAMA_MODEL_WEIGHTS
)

OLLAMA_MODEL_WEIGHTS = [float(url.strip()) for url in OLLAMA_MODEL_WEIGHTS.split(";")]

OLLAMA_LOAD_BALANCING_STRATEGY = os.environ.get(
    "OLLAMA_LOAD_BALANCING_STRATEGY", "round-robin"
)
OLLAMA_LOAD_BALANCING_STRATEGY = (
    OLLAMA_LOAD_BALANCING_STRATEGY
    if OLLAMA_LOAD_BALANCING_STRATEGY != ""
    else OLLAMA_LOAD_BALANCING_STRATEGY
)
