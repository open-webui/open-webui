...
class ERROR_MESSAGES(str, Enum):
    ...
    OPENAI_NOT_FOUND = lambda name="": "Voltron API was not found"
    OLLAMA_NOT_FOUND = "Voltron could not connect to Ollama"
    ...
    OLLAMA_API_DISABLED = (
        "The Voltron API is disabled. Please enable it to use this feature."
    )
