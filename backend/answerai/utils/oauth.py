...
from answerai.models.auths import Auths
from answerai.models.users import Users
from answerai.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from answerai.constants import ERROR_MESSAGES, WEBHOOK_MESSAGES
...
from answerai.utils.misc import parse_duration
from answerai.utils.auth import get_password_hash, create_token
from answerai.utils.webhook import post_webhook

from answerai.env import SRC_LOG_LEVELS, GLOBAL_LOG_LEVEL
...
class OAuthManager:
    ...
    def update_user_groups(self, user, user_data, default_permissions):
        ...
        log.debug(
            f"All groups available in AnswerAI: {[g.name for g in all_available_groups]}"
        )
