...
from answerai.utils import logger
from answerai.utils.audit import AuditLevel, AuditLoggingMiddleware
from answerai.utils.logger import start_logger
from answerai.socket.main import (
    app as socket_app,
    periodic_usage_pool_cleanup,
    get_models_in_use,
    get_active_user_ids,
)
from answerai.routers import (
    audio,
    images,
    ollama,
    openai,
...
from answerai.internal.db import Session, engine

from answerai.models.functions import Functions
from answerai.models.models import Models
from answerai.models.users import UserModel, Users
from answerai.models.chats import Chats
...
from answerai.utils.models import (
    get_all_models,
    get_all_base_models,
    check_model_access,
)
from answerai.utils.chat import (
    generate_chat_completion as chat_completion_handler,
    chat_completed as chat_completed_handler,
    chat_action as chat_action_handler,
)
from answerai.utils.embeddings import generate_embeddings
from answerai.utils.middleware import process_chat_payload, process_chat_response
from answerai.utils.access_control import has_access
...
from answerai.utils.plugin import install_tool_and_function_dependencies
from answerai.utils.oauth import OAuthManager
from answerai.utils.security_headers import SecurityHeadersMiddleware
from answerai.utils.redis import get_redis_connection

from answerai.tasks import (
...
from answerai.utils.redis import get_sentinels_from_env
...
https://github.com/answerai/answerai
"""
)
...
if ENABLE_OTEL:
    from answerai.utils.telemetry.setup import setup as setup_opentelemetry
    ...
    try:
        ...
        async with aiohttp.ClientSession(timeout=timeout, trust_env=True) as session:
            async with session.get(
                "https://api.github.com/repos/answerai/answerai/releases/latest",
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for AnswerAI.
