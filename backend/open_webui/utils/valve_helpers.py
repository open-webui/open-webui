...
def update_function_valves(function_id: str, valve_updates: dict) -> bool:
    ...
    try:
        ...
        log.exception(f"Error updating function valves from within function {function_id}: {e}")
        return False
...
def get_function_valves(function_id: str) -> dict:
    ...
    try:
        ...
        log.exception(f"Error getting function valves from within function {function_id}: {e}")
        return {}
