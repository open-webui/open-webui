...
from open_webui.config import BYPASS_ADMIN_ACCESS_CONTROL, DEFAULT_ARENA_MODEL
        ...
        if custom_model.base_model_id is None:
            ...
            model = {
                ...
                **(
                    ...
                    if base_model and base_model.get("provider")
                    else {}
                ),
                **(
                    {"loaded": base_model.get("loaded")}
                    if base_model and base_model.get("loaded") is not None
                    else {}
                ),
            }
