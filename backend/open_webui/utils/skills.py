...
def _build_skill_create_prompt(user_request: str) -> str:
    ...
    return (
        ...
        '4. Save with the selected terminal tools. Run `printf %s "$HOME"` '
        'through `run_command`, then write SKILL.md at '
        '<terminal-home>/.agents/skills/<skill-name>/SKILL.md. If the skill '
