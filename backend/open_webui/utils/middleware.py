...
def ensure_user_selected_skill_has_prompt(
    ...
    has_active_user_skill = any(getattr(skill, 'id', None) in user_skill_ids for skill in available_skills)
    if not has_active_user_skill:
        return
    ...
    set_last_user_message_content(SKILL_ONLY_USER_PROMPT, messages)
