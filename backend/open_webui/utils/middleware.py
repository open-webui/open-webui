...
def get_images_from_messages(message_list):
    ...
    for message in reversed(message_list):
        ...
        for file in message.get('files', []):
            ...
            elif is_vision_image_content_type(file.get('content_type')):
                message_images.append(file.get('url'))
        ...
        if db_messages:
            ...
            for message in form_data['messages']:
                image_files = [
                    ...
                    if f.get('type') == 'image' or is_vision_image_content_type(f.get('content_type'))
                ]
    ...
    if is_note_chat:
        ...
        if note and (
            ...
            note_files = [
                ...
                and not is_vision_image_content_type(file.get('content_type'))
            ]
            if note_files:
