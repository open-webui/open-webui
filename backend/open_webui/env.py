...
ENABLE_PROFILE_IMAGE_URL_FORWARDING = (
    os.environ.get("ENABLE_PROFILE_IMAGE_URL_FORWARDING", "True").lower() == "true"
)
...
DATABASE_SQLITE_PRAGMA_SYNCHRONOUS = os.environ.get(
...
DATABASE_SQLITE_PRAGMA_BUSY_TIMEOUT = os.environ.get(
    "DATABASE_SQLITE_PRAGMA_BUSY_TIMEOUT", "5000"
)

# PRAGMA cache_size: negative value = KiB.  -65536 ≈ 64 MB page cache.
DATABASE_SQLITE_PRAGMA_CACHE_SIZE = os.environ.get(
    "DATABASE_SQLITE_PRAGMA_CACHE_SIZE", "-65536"
)

# PRAGMA temp_store: MEMORY (2) keeps temp tables and indices in RAM.
# Valid values: DEFAULT (0), FILE (1), MEMORY (2).
DATABASE_SQLITE_PRAGMA_TEMP_STORE = os.environ.get(
...
DATABASE_SQLITE_PRAGMA_MMAP_SIZE = os.environ.get(
...
DATABASE_SQLITE_PRAGMA_JOURNAL_SIZE_LIMIT = os.environ.get(
    "DATABASE_SQLITE_PRAGMA_JOURNAL_SIZE_LIMIT", "67108864"
)
...
BYPASS_PYDUB_PREPROCESSING = (
    os.environ.get("BYPASS_PYDUB_PREPROCESSING", "False").lower() == "true"
)
...
ENABLE_OPENAI_API_PASSTHROUGH = (
    os.environ.get("ENABLE_OPENAI_API_PASSTHROUGH", "False").lower() == "true"
)
...
ENABLE_OAUTH_BACKCHANNEL_LOGOUT = (
    os.environ.get("ENABLE_OAUTH_BACKCHANNEL_LOGOUT", "False").lower() == "true"
)
...
ENABLE_IMAGE_CONTENT_TYPE_EXTENSION_FALLBACK = (
    os.environ.get("ENABLE_IMAGE_CONTENT_TYPE_EXTENSION_FALLBACK", "False").lower()
    == "true"
)
...
AIOHTTP_CLIENT_ALLOW_REDIRECTS = (
    os.environ.get("AIOHTTP_CLIENT_ALLOW_REDIRECTS", "False").lower() == "true"
)
...
AIOHTTP_POOL_CONNECTIONS_PER_HOST = os.environ.get(
...
ENABLE_AUDIT_GET_REQUESTS = (
    os.getenv("ENABLE_AUDIT_GET_REQUESTS", "False").lower() == "true"
)
