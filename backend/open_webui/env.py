...
if (DATABASE_URL := os.environ.get("DATABASE_URL")) is None:
    db_vars = {
    ...
    if all(db_vars.values()):
        DATABASE_URL = f"postgresql://{db_vars['db_user']}:{db_vars['db_password']}@{db_vars['db_host']}:{db_vars['db_port']}/{db_vars['db_name']}"
    else:
