...
def get_from_env_or_default(name: str, default: int) -> int:
...
DATABASE_POOL_SIZE = get_from_env_or_default("DATABASE_POOL_SIZE", 0)
DATABASE_POOL_MAX_OVERFLOW = get_from_env_or_default("DATABASE_POOL_MAX_OVERFLOW", 0)
DATABASE_POOL_TIMEOUT = get_from_env_or_default("DATABASE_POOL_TIMEOUT", 30)
DATABASE_POOL_RECYCLE = get_from_env_or_default("DATABASE_POOL_RECYCLE", 3600)
