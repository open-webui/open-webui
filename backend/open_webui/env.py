...
WEBSOCKET_EVENT_CALL_TIMEOUT = os.environ.get("WEBSOCKET_EVENT_CALL_TIMEOUT", "300")
try:
    WEBSOCKET_EVENT_CALL_TIMEOUT = int(WEBSOCKET_EVENT_CALL_TIMEOUT)
except ValueError:
    WEBSOCKET_EVENT_CALL_TIMEOUT = 300
