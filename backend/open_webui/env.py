...
EXTERNAL_DOCUMENT_LOADER_TIMEOUT = os.environ.get(
    "EXTERNAL_DOCUMENT_LOADER_TIMEOUT", "600"
)

if EXTERNAL_DOCUMENT_LOADER_TIMEOUT == "":
    EXTERNAL_DOCUMENT_LOADER_TIMEOUT = None
else:
    try:
        EXTERNAL_DOCUMENT_LOADER_TIMEOUT = int(
