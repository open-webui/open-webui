...
MCP_STREAMABLE_HTTP_CLIENT_TIMEOUT = os.environ.get('MCP_STREAMABLE_HTTP_CLIENT_TIMEOUT', '')

if MCP_STREAMABLE_HTTP_CLIENT_TIMEOUT == '':
    MCP_STREAMABLE_HTTP_CLIENT_TIMEOUT = None
else:
    try:
        MCP_STREAMABLE_HTTP_CLIENT_TIMEOUT = int(MCP_STREAMABLE_HTTP_CLIENT_TIMEOUT)
    except Exception:
        MCP_STREAMABLE_HTTP_CLIENT_TIMEOUT = None
