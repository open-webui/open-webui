...
class ERROR_MESSAGES(str, Enum):
    ...
    INVALID_EMAIL_DOMAIN = "The email domain you entered is invalid. Please double-check and make sure you're using a valid email domain (e.g., yourname@example.com)."
