...
# In local dev, FRONTEND_BUILD_DIR may not exist (or may not contain a build yet).
# Avoid deleting tracked/static assets in that case.
...
S3_PROMPT_BUCKET_NAME = os.environ.get("S3_PROMPT_BUCKET_NAME", S3_BUCKET_NAME)
DEFAULT_HELP_S3_KEY = os.environ.get(
    "DEFAULT_HELP_S3_KEY", "prompts/default-help.md"
)
...
USER_PERMISSIONS_FEATURES_UPLOADS = (
    os.environ.get("USER_PERMISSIONS_FEATURES_UPLOADS", "True").lower() == "true"
)
...
DEFAULT_USER_PERMISSIONS = {
    ...
    "features": {
        ...
        "uploads": USER_PERMISSIONS_FEATURES_UPLOADS,
    },
}
...
ENABLE_UPLOADS = PersistentConfig(
    "ENABLE_UPLOADS",
    "uploads.enable",
    os.environ.get("ENABLE_UPLOADS", "True").lower() == "true",
)
