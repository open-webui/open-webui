...
USER_PERMISSIONS_WORKSPACE_ANALYTICS_ACCESS = (
    os.environ.get("USER_PERMISSIONS_WORKSPACE_ANALYTICS_ACCESS", "True").lower() == "true"
)
...
DEFAULT_USER_PERMISSIONS = {
    "workspace": {
        ...
        "analytics": USER_PERMISSIONS_WORKSPACE_ANALYTICS_ACCESS,
    },
    "sharing": {
