...
USER_PERMISSIONS_CALENDAR_ALLOW_PUBLIC_SHARING = (
    os.environ.get("USER_PERMISSIONS_CALENDAR_ALLOW_PUBLIC_SHARING", "False").lower()
    == "true"
)
...
USER_PERMISSIONS_CHAT_ALLOW_PUBLIC_SHARING = (
    os.environ.get("USER_PERMISSIONS_CHAT_ALLOW_PUBLIC_SHARING", "False").lower()
    == "true"
)
...
ENABLE_ONEDRIVE_PERSONAL = os.environ.get(
    "ENABLE_ONEDRIVE_PERSONAL", "True"
).lower() == "true" and bool(ONEDRIVE_CLIENT_ID_PERSONAL)
ENABLE_ONEDRIVE_BUSINESS = os.environ.get(
    "ENABLE_ONEDRIVE_BUSINESS", "True"
).lower() == "true" and bool(ONEDRIVE_CLIENT_ID_BUSINESS)
