...
USER_PERMISSIONS_WORKSPACE_MODELS_ALLOW_PRIVATE_SHARING = (
    os.environ.get(
        "USER_PERMISSIONS_WORKSPACE_MODELS_ALLOW_PRIVATE_SHARING", "False"
    ).lower()
    == "true"
)

USER_PERMISSIONS_WORKSPACE_KNOWLEDGE_ALLOW_PRIVATE_SHARING = (
    os.environ.get(
        "USER_PERMISSIONS_WORKSPACE_KNOWLEDGE_ALLOW_PRIVATE_SHARING", "False"
    ).lower()
    == "true"
)

USER_PERMISSIONS_WORKSPACE_PROMPTS_ALLOW_PRIVATE_SHARING = (
    os.environ.get(
        "USER_PERMISSIONS_WORKSPACE_PROMPTS_ALLOW_PRIVATE_SHARING", "False"
    ).lower()
    == "true"
)

USER_PERMISSIONS_WORKSPACE_TOOLS_ALLOW_PRIVATE_SHARING = (
    os.environ.get(
        "USER_PERMISSIONS_WORKSPACE_TOOLS_ALLOW_PRIVATE_SHARING", "False"
    ).lower()
    == "true"
)
...
DEFAULT_USER_PERMISSIONS = {
    ...
    "sharing": {
        ...
        "private_models": USER_PERMISSIONS_WORKSPACE_MODELS_ALLOW_PRIVATE_SHARING,
        "private_knowledge": USER_PERMISSIONS_WORKSPACE_KNOWLEDGE_ALLOW_PRIVATE_SHARING,
        "private_prompts": USER_PERMISSIONS_WORKSPACE_PROMPTS_ALLOW_PRIVATE_SHARING,
        "private_tools": USER_PERMISSIONS_WORKSPACE_TOOLS_ALLOW_PRIVATE_SHARING,
    },
    "chat": {
