...
RAG_PROMPT_GENERATION_TEMPLATE = PersistentConfig(
    "RAG_PROMPT_GENERATION_TEMPLATE",
    "rag.prompt_generation_template",
    os.environ.get("RAG_PROMPT_GENERATION_TEMPLATE", DEFAULT_RAG_PROMPT_GENERATION_TEMPLATE),
)
