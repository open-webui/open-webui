...
CONTEXT_COMPACTION_RETAINED_MESSAGES_PERCENTAGE = int(
    os.getenv('CONTEXT_COMPACTION_RETAINED_MESSAGES_PERCENTAGE', '50')
)
...
DEFAULT_CONFIG = {
    ...
    'chat.context_compaction.retained_messages_percentage': CONTEXT_COMPACTION_RETAINED_MESSAGES_PERCENTAGE,
