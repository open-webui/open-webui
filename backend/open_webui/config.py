...
USER_PERMISSIONS_CHAT_ALLOW_CUSTOM_SYSTEM_PROMPT = (
    os.environ.get("USER_PERMISSIONS_CHAT_ALLOW_CUSTOM_SYSTEM_PROMPT", "True").lower() == "true"
)
...
DEFAULT_USER_PERMISSIONS = {
    ...
    "chat": {
        ...
        "allow_custom_system_prompt": USER_PERMISSIONS_CHAT_ALLOW_CUSTOM_SYSTEM_PROMPT,
    },
    "features": {
