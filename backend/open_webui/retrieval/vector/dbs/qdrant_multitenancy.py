...
class QdrantClient(VectorDBBase):
    ...
    def _get_collection_and_tenant_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current PrivateDesk AI naming conventions for
        collection names. If PrivateDesk AI changes how it generates collection names
