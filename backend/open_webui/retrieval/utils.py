...
def extract_pdf_from_url(request, url: str) -> str:
    ...
    with requests.Session() as session:
        ...
        # Reject oversized PDFs early via Content-Length when available.
        try:
        ...
        # Stream the body in chunks and abort if it exceeds the size limit.
        # This prevents buffering arbitrarily large responses into memory
        # when Content-Length is missing or inaccurate (e.g. chunked encoding).
        chunks = []
        downloaded = 0
