...
app.state.config.RAG_PERFORMANCE_PROFILE = RAG_PERFORMANCE_PROFILE
app.state.config.RAG_AUTO_SUSPEND = RAG_AUTO_SUSPEND
app.state.config.RAG_AUTO_SUSPEND_IDLE_SECONDS = RAG_AUTO_SUSPEND_IDLE_SECONDS
...
app.include_router(rag_admin.router, tags=["rag"])
