...
app.state.config.EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD = EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD
app.state.config.EXTERNAL_DOCUMENT_LOADER_ENDPOINT = EXTERNAL_DOCUMENT_LOADER_ENDPOINT
app.state.config.EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT = EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT
app.state.config.EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME = EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME
app.state.config.EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME = EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME
app.state.config.EXTERNAL_DOCUMENT_LOADER_PARAMS = EXTERNAL_DOCUMENT_LOADER_PARAMS
app.state.config.EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS = EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS
app.state.config.EXTERNAL_DOCUMENT_LOADER_HEADERS = EXTERNAL_DOCUMENT_LOADER_HEADERS
app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH = EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH
app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH = EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH
app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE = EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE
