...
from open_webui.config import (
    ...
    DEFAULT_RAG_QUERY_GENERATION_TEMPLATE,
    WEBHOOK_URL,
    WEBUI_AUTH,
    WEBUI_NAME,
    AppConfig,
...
async def chat_completion_files_handler(
    ...
    if files := body.get("metadata", {}).get("files", None):
        ...
        if retrieval_app.state.config.ENABLE_RAG_QUERY_GENERATION:
            if retrieval_app.state.config.RAG_QUERY_GENERATION_TEMPLATE != "":
                template = retrieval_app.state.config.RAG_QUERY_GENERATION_TEMPLATE
            else:
                template = DEFAULT_RAG_QUERY_GENERATION_TEMPLATE
