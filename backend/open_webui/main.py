...
app.state.config.DOCLING_VLM_PIPELINE_MODEL = DOCLING_VLM_PIPELINE_MODEL
app.state.config.DOCLING_VLM_PIPELINE_MODEL_LOCAL = DOCLING_VLM_PIPELINE_MODEL_LOCAL
app.state.config.DOCLING_VLM_PIPELINE_MODEL_API = DOCLING_VLM_PIPELINE_MODEL_API
