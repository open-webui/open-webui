...
app.state.config.LINKUP_SEARCH_URL = LINKUP_SEARCH_URL
app.state.config.LINKUP_SEARCH_DEPTH = LINKUP_SEARCH_DEPTH
app.state.config.LINKUP_OUTPUT_TYPE = LINKUP_OUTPUT_TYPE
