...
app.state.config.CUSTOM_IMAGE_GENERATION_URL = CUSTOM_IMAGE_GENERATION_URL
app.state.config.CUSTOM_IMAGE_GENERATION_HEADERS = CUSTOM_IMAGE_GENERATION_HEADERS
app.state.config.CUSTOM_IMAGE_GENERATION_BODY = CUSTOM_IMAGE_GENERATION_BODY
app.state.config.CUSTOM_IMAGE_DOWNLOAD_URL = CUSTOM_IMAGE_DOWNLOAD_URL
app.state.config.CUSTOM_IMAGE_DOWNLOAD_HEADERS = CUSTOM_IMAGE_DOWNLOAD_HEADERS
