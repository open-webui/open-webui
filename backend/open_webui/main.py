...
app.state.config.EXTERNAL_DOCUMENT_LOADER_TIMEOUT = EXTERNAL_DOCUMENT_LOADER_TIMEOUT
app.state.config.ENABLE_EXTERNAL_LOADER_AUTO_FALLBACK = ENABLE_EXTERNAL_LOADER_AUTO_FALLBACK
