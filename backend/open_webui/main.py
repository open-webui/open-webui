...
app.state.config.ENABLE_SSRF_PROTECTION = ENABLE_SSRF_PROTECTION
app.state.config.SSRF_BLOCKED_HOSTNAMES = SSRF_BLOCKED_HOSTNAMES
app.state.config.SSRF_BLOCKED_IP_RANGES = SSRF_BLOCKED_IP_RANGES
