...
async def lifespan(app: FastAPI):
    ...
    if app.state.config.ENABLE_KNOWLEDGE_DRIVE_SYNC and app.state.config.ENABLE_KNOWLEDGE_DRIVE_PERIODIC_SYNC:
...
app.state.config.GMAIL_PERIODIC_SYNC_INTERVAL_MINUTES = GMAIL_PERIODIC_SYNC_INTERVAL_MINUTES
app.state.config.GMAIL_PERIODIC_SYNC_CHECK_INTERVAL_MINUTES = GMAIL_PERIODIC_SYNC_CHECK_INTERVAL_MINUTES
