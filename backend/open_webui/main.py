...
app.state.config.VIEWCOMFY_API_URL = VIEWCOMFY_API_URL
app.state.config.VIEWCOMFY_CLIENT_ID = VIEWCOMFY_CLIENT_ID
app.state.config.VIEWCOMFY_CLIENT_SECRET = VIEWCOMFY_CLIENT_SECRET
app.state.config.VIEWCOMFY_WORKFLOW = VIEWCOMFY_WORKFLOW
app.state.config.VIEWCOMFY_WORKFLOW_NODES = VIEWCOMFY_WORKFLOW_NODES
