...
app.state.config.GROUNDING_MODEL = GROUNDING_MODEL
app.state.config.GROUNDING_MODEL_WIDTH = GROUNDING_MODEL_WIDTH
app.state.config.GROUNDING_MODEL_HEIGHT = GROUNDING_MODEL_HEIGHT
