...
app.state.config.RAG_VERTEXAI_RERANKER_PROJECT_ID = RAG_VERTEXAI_RERANKER_PROJECT_ID
app.state.config.RAG_VERTEXAI_RERANKER_LOCATION = RAG_VERTEXAI_RERANKER_LOCATION
app.state.config.RAG_VERTEXAI_RERANKER_RANKING_CONFIG = RAG_VERTEXAI_RERANKER_RANKING_CONFIG
...
try:
    ...
    if (
        ...
        app.state.rf = get_rf(
            ...
            app.state.config.RAG_VERTEXAI_RERANKER_PROJECT_ID,
            app.state.config.RAG_VERTEXAI_RERANKER_LOCATION,
            app.state.config.RAG_VERTEXAI_RERANKER_RANKING_CONFIG,
            RAG_RERANKING_MODEL_AUTO_UPDATE,
        )
    else:
        app.state.rf = None
