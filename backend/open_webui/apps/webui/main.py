...
app.state.config.ENABLE_USER_COUNT_WEBSOCKET_UPDATES = ENABLE_USER_COUNT_WEBSOCKET_UPDATES
app.state.config.ENABLE_USAGE_WEBSOCKET_UPDATES = ENABLE_USAGE_WEBSOCKET_UPDATES
