...
from open_webui.utils.access_control import enforce_knowledge_upload_limits
                ...
                try:
                    ...
                    if not can_write:
                        ...
                        await enforce_knowledge_upload_limits(
                            user, knowledge_id, (file_item.meta or {}).get('size', 0), db=db_session,
                        )
...
async def upload_file_handler(
    ...
    try:
        ...
        if knowledge_id:
            ...
            if can_write:
                try:
                    await enforce_knowledge_upload_limits(user, knowledge_id, len(contents), db=db)
