            ...
            try:
                ...
                with httpx.Client(timeout=120.0) as client:
                    response = client.post(
                        ...
                        json={"file_id": file_id, "model": model_id},
                        headers={
            ...
            if content_type:
                ...
                if strict_match_mime_type(stt_supported_content_types, content_type):
                    ...
                    if result.get('segments'):
                        trigger_chapter_generation_background(request, file_item.id, user)
...
async def stream_video_by_id(
    ...
    try:
        ...
        if ext_lower in (".mp4", ".mov"):
            ...
            remux_needed = (not cache_path.exists()) or (cache_path.stat().st_mtime < src_path.stat().st_mtime)
