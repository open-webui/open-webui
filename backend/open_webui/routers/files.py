        ...
        try:
            ...
            if content_type:
                ...
                if strict_match_mime_type(stt_supported_content_types, content_type):
                    file_path_processed = await asyncio.to_thread(
...
async def upload_file_handler(
    ...
    try:
        ...
        if "channel_id" in file_metadata:
            ...
            if channel:
                await Channels.add_file_to_channel_by_id(
...
async def list_files(
    ...
    result = await Files.get_file_list(
        ...
        if stream:
            ...
            async def event_stream(file_id):
                ...
                for _ in range(MAX_FILE_PROCESSING_DURATION):
                    file_item = await Files.get_file_by_id(
                        file_id
                    )  # Creates own session
                    if file_item:
