    ...
    if function:
        ...
        if hasattr(function_module, "Valves"):
            ...
            try:
                ...
                # Only persist explicitly provided fields; do not expand defaults
                minimal = valves.model_dump(exclude_unset=True)
                Functions.update_function_valves_by_id(id, minimal)
                return minimal
            except Exception as e:
    ...
    if function:
        ...
        if hasattr(function_module, "UserValves"):
            ...
            try:
                ...
                Functions.update_user_valves_by_id_and_user_id(id, user.id, minimal)
                return minimal
            except Exception as e:
