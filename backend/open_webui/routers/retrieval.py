...
from open_webui.config import WEB_SEARCH_RATE_LIMIT_MAX_REQUESTS, WEB_SEARCH_RATE_LIMIT_MIN_SECONDS, WEB_SEARCH_RATE_LIMIT_ENABLED
...
def search_rate_limit(max_calls: int, period: float):
    ...
    def decorator(func):
        ...
        return wrapper
    return decorator
@search_rate_limit(int(WEB_SEARCH_RATE_LIMIT_MAX_REQUESTS.value), int(WEB_SEARCH_RATE_LIMIT_MIN_SECONDS.value))
