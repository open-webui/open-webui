...
async def get_rag_config(request: Request, user=Depends(get_admin_user)):
    return {
        ...
        "EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD,
        "EXTERNAL_DOCUMENT_LOADER_ENDPOINT": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_ENDPOINT,
        "EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT,
        "EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME,
        "EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME,
        "EXTERNAL_DOCUMENT_LOADER_PARAMS": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_PARAMS,
        "EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS,
        "EXTERNAL_DOCUMENT_LOADER_HEADERS": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_HEADERS,
        "EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH,
        "EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH,
        "EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE": request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE,
...
class ConfigForm(BaseModel):
    ...
    EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD: Optional[str] = None
    EXTERNAL_DOCUMENT_LOADER_ENDPOINT: Optional[str] = None
    EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT: Optional[str] = None
    EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME: Optional[str] = None
    EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME: Optional[str] = None
    EXTERNAL_DOCUMENT_LOADER_PARAMS: Optional[dict] = None
    EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS: Optional[dict] = None
    EXTERNAL_DOCUMENT_LOADER_HEADERS: Optional[dict] = None
    EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH: Optional[str] = None
    EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH: Optional[str] = None
    EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE: Optional[str] = None
...
async def update_rag_config(
    ...
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD = (
        form_data.EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD
        if form_data.EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_HTTP_METHOD
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_ENDPOINT = (
        form_data.EXTERNAL_DOCUMENT_LOADER_ENDPOINT
        if form_data.EXTERNAL_DOCUMENT_LOADER_ENDPOINT is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_ENDPOINT
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT = (
        form_data.EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT
        if form_data.EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_REQUEST_FORMAT
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME = (
        form_data.EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME
        if form_data.EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_FILE_FIELD_NAME
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME = (
        form_data.EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME
        if form_data.EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_FILENAME_FIELD_NAME
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_PARAMS = (
        form_data.EXTERNAL_DOCUMENT_LOADER_PARAMS
        if form_data.EXTERNAL_DOCUMENT_LOADER_PARAMS is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_PARAMS
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS = (
        form_data.EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS
        if form_data.EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_QUERY_PARAMS
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_HEADERS = (
        form_data.EXTERNAL_DOCUMENT_LOADER_HEADERS
        if form_data.EXTERNAL_DOCUMENT_LOADER_HEADERS is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_HEADERS
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH = (
        form_data.EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH
        if form_data.EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_CONTENT_PATH
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH = (
        form_data.EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH
        if form_data.EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_METADATA_PATH
    )
    request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE = (
        form_data.EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE
        if form_data.EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE is not None
        else request.app.state.config.EXTERNAL_DOCUMENT_LOADER_RESPONSE_TYPE
    )
