...
async def get_status(request: Request):
    return {
        ...
        "EMBEDDING_MAX_CONCURRENCY": request.app.state.config.EMBEDDING_MAX_CONCURRENCY,
    }
...
class EmbeddingModelUpdateForm(BaseModel):
    ...
    EMBEDDING_MAX_CONCURRENCY: Optional[int] = 0
...
async def update_embedding_config(
    ...
    try:
        ...
        request.app.state.config.EMBEDDING_MAX_CONCURRENCY = (
            form_data.EMBEDDING_MAX_CONCURRENCY
            if form_data.EMBEDDING_MAX_CONCURRENCY is not None
            else request.app.state.config.EMBEDDING_MAX_CONCURRENCY
        )
