...
async def send_get_request(request: Request, url, key=None, user: UserModel = None, config=None):
...
async def get_models_request(request: Request, url, key=None, user: UserModel = None, config=None):
