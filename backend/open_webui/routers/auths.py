...
from open_webui.config import OPENID_PROVIDER_URL, ENABLE_OAUTH_SIGNUP, ENABLE_LDAP, DEFAULT_GROUP_ID
...
async def get_admin_config(request: Request, user=Depends(get_admin_user)):
    return {
        ...
        "DEFAULT_GROUP_ID": DEFAULT_GROUP_ID.value,
...
async def update_admin_config(
    ...
    DEFAULT_GROUP_ID.value = form_data.DEFAULT_GROUP_ID
