...
ADMIN_CONFIG_KEYS = {
    ...
    'DEFAULT_USER_UI_SETTINGS': 'ui.default_user_settings',
...
class AdminConfig(BaseModel):
    ...
    DEFAULT_USER_UI_SETTINGS: dict | None = None
    JWT_EXPIRES_IN: str
...
async def update_admin_config(request: Request, form_data: AdminConfig, user=Depends(get_admin_user)):
    ...
    updates['ui.default_user_settings'] = form_data.DEFAULT_USER_UI_SETTINGS or {}
