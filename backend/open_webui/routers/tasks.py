...
async def get_task_config(request: Request, user=Depends(get_verified_user)):
    return {
        ...
        "TOOL_CALLING_MODEL": request.app.state.config.TOOL_CALLING_MODEL,
        "TOOL_CALLING_MODEL_EXTERNAL": request.app.state.config.TOOL_CALLING_MODEL_EXTERNAL,
...
class TaskConfigForm(BaseModel):
    ...
    TOOL_CALLING_MODEL: Optional[str]
    TOOL_CALLING_MODEL_EXTERNAL: Optional[str]
...
async def update_task_config(
    ...
    request.app.state.config.TOOL_CALLING_MODEL = form_data.TOOL_CALLING_MODEL
    request.app.state.config.TOOL_CALLING_MODEL_EXTERNAL = form_data.TOOL_CALLING_MODEL_EXTERNAL
