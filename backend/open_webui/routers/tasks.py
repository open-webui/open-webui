...
async def get_task_config(request: Request, user=Depends(get_verified_user)):
    return {
        ...
        'AUTOCOMPLETE_GENERATION_PROMPT_TEMPLATE': request.app.state.config.AUTOCOMPLETE_GENERATION_PROMPT_TEMPLATE,
...
async def update_task_config(request: Request, form_data: TaskConfigForm, user=Depends(get_admin_user)):
    ...
    request.app.state.config.AUTOCOMPLETE_GENERATION_PROMPT_TEMPLATE = (
        form_data.AUTOCOMPLETE_GENERATION_PROMPT_TEMPLATE
    )
