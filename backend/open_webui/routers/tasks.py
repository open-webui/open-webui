...
async def get_task_config(request: Request, user=Depends(get_verified_user)):
    return {
        ...
        "ALLOW_MULTIPLE_SEARCH_QUERIES": request.app.state.config.ALLOW_MULTIPLE_SEARCH_QUERIES,
...
class TaskConfigForm(BaseModel):
    ...
    ALLOW_MULTIPLE_SEARCH_QUERIES: bool
...
async def update_task_config(
    ...
    request.app.state.config.ALLOW_MULTIPLE_SEARCH_QUERIES = (
        form_data.ALLOW_MULTIPLE_SEARCH_QUERIES
    )
