...
async def update_prompt_by_id(
    ...
    updated_prompt = await Prompts.update_prompt_by_id(
...
async def set_prompt_version(
    ...
    updated_prompt = await Prompts.update_prompt_version(
...
async def get_prompt_history(
    ...
    history = await PromptHistories.get_history_by_prompt_id(
