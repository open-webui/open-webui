...
class FileMaskRequest:
    ...
    known_entities: Union[
        None, Unset, list["FileMaskRequestKnownEntitiesType0Item"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_known_entities(
            data: object,
        ) -> Union[None, Unset, list["FileMaskRequestKnownEntitiesType0Item"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for known_entities_type_0_item_data in _known_entities_type_0:
                    known_entities_type_0_item = (
                        FileMaskRequestKnownEntitiesType0Item.from_dict(
                ...
                pass
            return cast(
                Union[None, Unset, list["FileMaskRequestKnownEntitiesType0Item"]], data
            )
