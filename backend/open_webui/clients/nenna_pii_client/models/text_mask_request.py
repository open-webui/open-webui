...
if TYPE_CHECKING:
  ...
  from ..models.text_mask_request_known_entities_type_0_item import TextMaskRequestKnownEntitiesType0Item
...
class TextMaskRequest:
    ...
    known_entities: Union[None, Unset, list['TextMaskRequestKnownEntitiesType0Item']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_known_entities(data: object) -> Union[None, Unset, list['TextMaskRequestKnownEntitiesType0Item']]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for known_entities_type_0_item_data in (_known_entities_type_0):
                    known_entities_type_0_item = TextMaskRequestKnownEntitiesType0Item.from_dict(known_entities_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list['TextMaskRequestKnownEntitiesType0Item']], data)
