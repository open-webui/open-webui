...
class ChatTable:
    ...
    def insert_new_chat(self, user_id: str, form_data: ChatForm, db: Session | None = None) -> ChatModel | None:
    ...
    def update_chat_by_id(self, id: str, chat: dict, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
    ...
    def update_chat_tags_by_id(self, id: str, tags: list[str], user) -> ChatModel | None:
    ...
    def get_chat_title_by_id(self, id: str) -> str | None:
        with get_db_context() as db:
    ...
    def get_messages_map_by_chat_id(self, id: str) -> dict | None:
        chat = self.get_chat_by_id(id)
        if chat is None:
            return None
    ...
    def get_message_by_id_and_message_id(self, id: str, message_id: str) -> dict | None:
        chat = self.get_chat_by_id(id)
        if chat is None:
            return None
    ...
    def upsert_message_to_chat_by_id_and_message_id(self, id: str, message_id: str, message: dict) -> ChatModel | None:
        chat = self.get_chat_by_id(id)
        if chat is None:
            return None
    ...
    def insert_shared_chat_by_chat_id(self, chat_id: str, db: Session | None = None) -> ChatModel | None:
        with get_db_context(db) as db:
    ...
    def update_shared_chat_by_chat_id(self, chat_id: str, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
                chat = db.get(Chat, chat_id)
    ...
    def delete_shared_chat_by_chat_id(self, chat_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def unarchive_all_chats_by_user_id(self, user_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def update_chat_share_id_by_id(self, id: str, share_id: str | None, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
                chat = db.get(Chat, id)
    ...
    def toggle_chat_pinned_by_id(self, id: str, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
                chat = db.get(Chat, id)
    ...
    def toggle_chat_archive_by_id(self, id: str, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
                chat = db.get(Chat, id)
    ...
    def archive_all_chats_by_user_id(self, user_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def get_chat_title_id_list_by_user_id(
        ...
        with get_db_context(db) as db:
            ...
            # result has to be destructured from sqlalchemy `row` and mapped to a dict since
            # the `ChatModel` is not the returned dataclass.
            return [
                ChatTitleIdResponse.model_validate(
                    {
                        'id': chat[0],
    ...
    def get_chat_by_id(self, id: str, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
                chat_item = db.get(Chat, id)
    ...
    def get_chat_by_share_id(self, id: str, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
    ...
    def get_chat_by_id_and_user_id(self, id: str, user_id: str, db: Session | None = None) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
    ...
    def is_chat_owner(self, id: str, user_id: str, db: Session | None = None) -> bool:
        """
    ...
    def get_chat_folder_id(self, id: str, user_id: str, db: Session | None = None) -> str | None:
        """
    ...
    def get_chats(self, skip: int = 0, limit: int = 50, db: Session | None = None) -> list[ChatModel]:
        with get_db_context(db) as db:
            all_chats = (
                db.query(Chat)
    ...
    def get_pinned_chats_by_user_id(self, user_id: str, db: Session | None = None) -> list[ChatTitleIdResponse]:
        with get_db_context(db) as db:
            all_chats = (
                db.query(Chat)
    ...
    def get_archived_chats_by_user_id(self, user_id: str, db: Session | None = None) -> list[ChatModel]:
        with get_db_context(db) as db:
    ...
    def get_chats_by_user_id_and_search_text(
        ...
        # split the search_text and remove the tags
        tag_ids = [
        ...
        with get_db_context(db) as db:
            ...
            if is_archived is not None:
                ...
                query = query.filter(Chat.archived.is_(False))
    ...
    def get_chats_by_folder_ids_and_user_id(
        self, folder_ids: list[str], user_id: str, db: Session | None = None
    ) -> list[ChatModel]:
        with get_db_context(db) as db:
    ...
    def update_chat_folder_id_by_id_and_user_id(
        self, id: str, user_id: str, folder_id: str, db: Session | None = None
    ) -> ChatModel | None:
        try:
            with get_db_context(db) as db:
                chat = db.get(Chat, id)
    ...
    def get_chat_tags_by_id_and_user_id(self, id: str, user_id: str, db: Session | None = None) -> list[TagModel]:
        with get_db_context(db) as db:
            chat = db.get(Chat, id)
    ...
    def add_chat_tag_by_id_and_user_id_and_tag_name(
        self, id: str, user_id: str, tag_name: str, db: Session | None = None
    ) -> ChatModel | None:
        tag_id = tag_name.replace(' ', '_').lower()
    ...
    def count_chats_by_tag_name_and_user_id(self, tag_name: str, user_id: str, db: Session | None = None) -> int:
        with get_db_context(db) as db:
    ...
    def count_chats_by_folder_id_and_user_id(self, folder_id: str, user_id: str, db: Session | None = None) -> int:
        with get_db_context(db) as db:
            query = db.query(Chat).filter_by(user_id=user_id)
    ...
    def delete_all_tags_by_id_and_user_id(self, id: str, user_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
                chat = db.get(Chat, id)
                chat.meta = {
    ...
    def delete_chat_by_id(self, id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def delete_chat_by_id_and_user_id(self, id: str, user_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
                db.query(ChatMessage).filter_by(chat_id=id).delete()
    ...
    def delete_chats_by_user_id(self, user_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def delete_chats_by_user_id_and_folder_id(self, user_id: str, folder_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def delete_shared_chats_by_user_id(self, user_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def get_chat_files_by_chat_id_and_message_id(
        self, chat_id: str, message_id: str, db: Session | None = None
    ) -> list[ChatFileModel]:
        with get_db_context(db) as db:
            all_chat_files = (
                db.query(ChatFile)
    ...
    def delete_chat_file(self, chat_id: str, file_id: str, db: Session | None = None) -> bool:
        try:
            with get_db_context(db) as db:
    ...
    def get_shared_chats_by_file_id(self, file_id: str, db: Session | None = None) -> list[ChatModel]:
        with get_db_context(db) as db:
