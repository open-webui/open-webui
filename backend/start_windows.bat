...
uvicorn open_webui.main:app --host "%HOST%" --port "%PORT%" --workers %UVICORN_WORKERS% --ws auto
:: For ssl use: uvicorn open_webui.main:app --host "%HOST%" --port "%PORT%" --ssl-keyfile "key.pem" --ssl-certfile "cert.pem" --ws auto
