...
from config import WEBUI_AUTH, WEBUI_AUTH_TRUSTED_EMAIL_HEADER, WEB_AUTH_TRUSTED_NAME_HEADER
...
async def signin(request: Request, form_data: SigninForm):
    if WEBUI_AUTH_TRUSTED_EMAIL_HEADER:
        ...
        user = Users.get_user_by_email(trusted_email.lower())

        if not user:
            if WEBUI_AUTH_TRUSTED_NAME_HEADER and WEBUI_AUTH_TRUSTED_NAME_HEADER in request.headers:
                trusted_name = request.headers[WEBUI_AUTH_TRUSTED_NAME_HEADER]
            else:
