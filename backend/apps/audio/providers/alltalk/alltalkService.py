...
def get_alltalk_config():
    return {
        ...
        "ALLTALK_API_USE_STREAMING": config.ALLTALK_API_USE_STREAMING,
        "ALLTALK_API_USE_NARRATOR": config.ALLTALK_API_USE_NARRATOR,
        "ALLTALK_API_NARRATOR_VOICE": config.ALLTALK_API_NARRATOR_VOICE
    }