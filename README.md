...
Prefer not to run it yourself? Get a fully managed Open WebUI instance with storage, backups, and a free subdomain included, no server required:

[![Deploy with Zenith](https://cdn.zenith.hosting/buttons/deploy-with-zenith.svg)](https://zenith.hosting/host/open-webui)
