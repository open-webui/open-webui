...
If you are setting up Open WebUI on Windows with Python 3.13, you may encounter the following issues:

#### 1. Missing `audioop` Module
**Error:** `ModuleNotFoundError: No module named 'pyaudioop'`
**Cause:** Python 3.13 removed the legacy `audioop` module.
