...
COPY --chown=$UID:$GID ./static/favicon.ico /app/backend/open_webui/static/favicon.ico
...
ENV DOCKER=true
ENV WEBUI_NAME="ClapNClaw"
ENV CLAPNCLAW_API_URL=""
ENV CLAPNCLAW_WORKSPACE_SECRET=""
