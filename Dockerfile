...
ARG SCARF_NO_ANALYTICS
ARG DO_NOT_TRACK
ARG ANONYMIZED_TELEMETRY
...
ENV VITE_WEBUI_BASE_URL=$VITE_WEBUI_BASE_URL
ENV VITE_WEBUI_API_BASE_URL=$VITE_WEBUI_API_BASE_URL
ENV WEBUI_BASE_URL=$WEBUI_BASE_URL
ENV WEBUI_API_BASE_URL=$WEBUI_API_BASE_URL
...
ENV SCARF_NO_ANALYTICS=$SCARF_NO_ANALYTICS
ENV DO_NOT_TRACK=$DO_NOT_TRACK
ENV ANONYMIZED_TELEMETRY=$ANONYMIZED_TELEMETRY
