						...
						{#if Object.keys($config?.oauth?.providers ?? {}).length > 0}
							...
							<div class="flex flex-col space-y-2">
								{#if $config?.oauth?.providers?.google}
									...
									>
										<svg class="size-6 mr-3" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
											<path
								...
								{#if $config?.oauth?.providers?.microsoft}
									...
									>
										<svg class="size-6 mr-3" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg">
								...
								{#if $config?.oauth?.providers?.github}
									...
									>
										<svg class="size-6 mr-3" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
											<path
