			...
			<div class="w-full sm:max-w-md px-10 min-h-screen flex flex-col text-center">
				...
				{:else}
					<div class="my-auto pb-10 w-full dark:text-gray-100">
						...
						<div class="mt-5">
							<button
								class="flex justify-center items-center fr-background-action-high--blue-france text-white dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-s font-medium text-sm py-2.5"
								on:click={() => {
							...
							>
								<svg xmlns="http://www.w3.org/2000/svg" width="211" height="58" fill="none"
									><path
										fill="transparent"
										d="M0 4a4 4 0 0 1 4-4h203a4 4 0 0 1 4 4v50a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4z"
									></path><path
										fill="#fff"
									...
									></path><path
										fill="transparent"
										d="M46.992 19.098 31.998 10.42l-14.994 8.76a.6.6 0 0 0-.306.525v16.948a.67.67 0 0 0 .306.524l14.992 8.6L46.99 37.07a.67.67 0 0 0 .306-.524V19.626a.6.6 0 0 0-.304-.528"
									></path><path
										fill="#FCC63A"
