                ...
                <div class="w-full flex flex-col justify-center items-center">
                    ...
                    <div class="text-base font-normal md:max-w-3xl w-full py-3">
                        <div class="w-full font-primary bg-white dark:bg-gray-900 px-2.5 mx-auto inset-x-0">
                            <div class="flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border border-gray-50 dark:border-gray-850 hover:border-gray-100 focus-within:border-gray-100 hover:dark:border-gray-800 focus-within:dark:border-gray-800 transition px-1 bg-white/90 dark:bg-gray-400/5 dark:text-gray-100">
                                <div class="px-2.5">
                                    <div
