...
<svelte:head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@300;400;500;600;700&family=Koulen&display=swap"
		rel="stylesheet"
	/>
</svelte:head>

<div
	class="min-h-screen bg-[#050505] text-gray-100 font-['Chakra_Petch'] selection:bg-[#00ff41] selection:text-black overflow-x-hidden"
>
	<!-- CRT Overlay Effect -->
	<div
		class="fixed inset-0 pointer-events-none z-50 opacity-[0.03] bg-[url('https://grainy-gradients.vercel.app/noise.svg')]"
	></div>
	<div
		class="fixed inset-0 pointer-events-none z-50 bg-gradient-to-b from-transparent via-transparent to-black/20 bg-[length:100%_4px]"
	></div>
	...
	<!-- Header -->
	<div
		class="relative z-10 pt-12 pb-8 px-4 border-b border-white/10 bg-[#050505]/80 backdrop-blur-sm"
	>
		<div class="max-w-6xl mx-auto">
			<div class="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
				...
				>
					<div
						class="w-8 h-8 border border-current flex items-center justify-center group-hover:bg-[#00ff41] group-hover:text-black transition-all"
					>
						<svg
				...
				<div class="flex items-center gap-4">
					<div class="relative group">
						...
						<div
							class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[#00ff41]"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 20 20"
			...
			<div class="text-center relative">
				<div class="inline-block">
					<h1
						class="text-6xl md:text-9xl font-['Koulen'] text-white leading-none tracking-tighter uppercase mix-blend-difference relative z-10"
					>
						{selectedYear}
						<span class="text-transparent bg-clip-text bg-gradient-to-r from-[#00ff41] to-[#00ff41]"
							>Wrapped</span
						>
					</h1>
