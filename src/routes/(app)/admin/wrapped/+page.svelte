...
<div
	class="min-h-screen bg-[#050505] text-gray-100 font-['Chakra_Petch'] selection:bg-[#ff003c] selection:text-white overflow-x-hidden"
>
	<!-- CRT Overlay Effect -->
	<div
	...
	>
		<div class="max-w-6xl mx-auto">
			<div class="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
				...
				>
					<div
						class="w-8 h-8 border border-current flex items-center justify-center group-hover:bg-[#ff003c] group-hover:text-white transition-all"
					>
						<svg
				...
				<div class="flex items-center gap-4">
					<div class="relative group">
						...
						<div
							class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[#ff003c]"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								viewBox="0 0 20 20"
			...
			<div class="flex items-center justify-center gap-2 mb-4">
				<span
					class="px-3 py-1 border border-[#ff003c] text-[#ff003c] text-xs font-bold uppercase tracking-widest bg-[#ff003c]/10"
				>
			...
			<div class="text-center relative">
				<div class="inline-block">
					...
					>
						Global <span
							class="text-transparent bg-clip-text bg-gradient-to-r from-[#ff003c] to-[#ff003c]"
							>Wrapped</span
						>
					</h1>
