<script lang="ts">
	...
	import { user, prompts } from '$lib/stores';
	...
	<div class=" py-2.5 flex flex-col justify-between w-full">
		<div class="max-w-2xl mx-auto w-full px-3 md:px-0 my-10">
			<div class="mb-6 flex justify-between items-center">
				<div class=" text-2xl font-semibold self-center">Prompt Hub</div>
			</div>
			...
			{#if $prompts.length === 0}
				<div />
			{:else}
				{#each $prompts.filter((p) => p.verified && (query === '' || p.command.includes(query))) as prompt}
			...
			{#if $prompts.filter((p) => !p.verified && (p.user_id === $user.id || $user.role === 'admin')).length === 0}
				<div />
			{:else}
				<div class=" my-8">
			...
			<div class=" my-16">
				...
				<a class=" flex space-x-4 cursor-pointer w-full mb-3" href="/prompts/create">
					...
					<div class=" self-center">
						<div class=" font-bold">Create your prompt now!</div>
