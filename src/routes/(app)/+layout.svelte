...
{#if $user}
	<div class="app relative">
		<div
			class=" text-gray-100 bg-gradient-to-l from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950  h-screen max-h-[100dvh] overflow-auto flex flex-row justify-end"
		>
			{#if !['user', 'admin', 'professor'].includes($user?.role)}
				<AccountPending />
			{:else}
