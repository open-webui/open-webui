...
<div class="app relative">
	<div
		class=" text-lightGray-100 dark:text-gray-100 bg-lightGray-300 dark:bg-customGray-900 md:h-screen md:max-h-[100dvh] md:overflow-auto flex flex-row justify-end"
	>
		{#if loaded}
