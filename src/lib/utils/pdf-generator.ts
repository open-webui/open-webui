// PDF Generator Utility for Notes
// This utility provides consistent PDF generation from note content with dark mode support.
...
/**
 * Downloads a note as PDF with proper dark mode support
 * @param note - The note object containing content and title
 */
export const downloadPdf = async (note: { title: string; data: { content: NoteContent } }) => {
	try {
