...
export function getAllFiles(fs: PyodideFS, options: GetAllFilesOptions = {}): Set<string> {
	const { baseDirs = DEFAULT_BASE_DIRS, maxDepth = DEFAULT_MAX_DEPTH, getCwd } = options;
