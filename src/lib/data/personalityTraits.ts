		...
		subCharacteristics: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['Why do I lose track of my stuff?', "What happens when I'm disorganized?"],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['Why do I make silly mistakes?', 'What does it mean to be more mindful?'],
					negative: [
		...
		subCharacteristics: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['How do I burn energy before bedtime?', 'What are fun dares I can try?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['What makes someone a good leader?', 'How do I know when to take charge?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ["Why don't people listen to me?", 'What makes someone influential?'],
					negative: [
		...
		subCharacteristics: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['Why do I miss people sometimes?', 'How can I talk about my sad feelings?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ["Why don't things stress me out as much?", 'What helps me stay relaxed?'],
					negative: [
		...
		subCharacteristics: [
			{
				...
				questions: {
					...
					neutral: ['Why is the sky blue but space black?', 'How does a rainbow happen?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['Why do people believe different things?', 'What is time, really?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['Why do some songs make me cry?', 'How do artists get their ideas?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['How do I think outside the box?', 'Can you give me a puzzle to solve?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['How do I make up my own stories?', 'Can you help me name a new planet?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['Why do people create art?', 'What are different types of beauty?'],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ['Why am I not into art?', "What's good about focusing on other things?"],
					negative: [
			...
			},
			{
				...
				questions: {
					...
					neutral: ["Why don't I think of creative ideas?", 'What makes someone creative?'],
					negative: [
...
export function generateScenariosFromJSON(
	jsonData: any,
