...
<style>
  ...
  .modal-overlay {
    ...
    padding: 4px; /* Отступы для мобильных устройств */
  }
  ...
  .modal-content {
    ...
    max-height: 76vh; /* Максимальная высота (90% высоты экрана) */
  ...
  @media (max-width: 410px) {
    .modal-content {
      ...
      max-width: 100%;
      max-height: 76vh; /* Ограничиваем высоту */
      border-radius: 0; /* Убираем скругление углов */
      padding: 4px; /* Уменьшаем отступы для мобильных устройств */
    }
  }
