...
<div bind:this={folderElement} class="relative {className}">
	...
	{#if collapsible}
		...
		>
			...
			>
				<button
					class="w-full flex items-center gap-1.5 text-xs font-medium"
					class:justify-center={!showSidebar}
					class:justify-between={showSidebar}
				>
					<!-- Icon -->
