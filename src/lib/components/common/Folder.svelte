...
<div bind:this={folderElement} class="relative {className}">
	...
	{#if collapsible}
		...
		>
			...
			<div
				class="w-full group rounded-md relative flex items-center justify-between hover:bg-[#8900E1] dark:hover:bg-gray-700 text-gray-100 dark:text-gray-200 transition"
			>
