			...
			<div class="p-8 max-h-[90vh] overflow-y-auto" id="consent-content">
				...
				<div class="space-y-6 text-base dark:text-gray-200 leading-relaxed">
					...
					<div>
						...
						<p>
							Haojian Jin, Ph.D., Assistant Professor, Halıcıoğlu Data Science Institute, UC San
							Diego
						</p>
					</div>
					...
					<div>
						...
						<p>
							<a
								href="mailto:childai.research.ucsd@gmail.com"
								class="text-blue-600 dark:text-blue-400 underline"
								>childai.research.ucsd@gmail.com</a
							>
						</p>
					</div>
					...
					<div>
						...
						<p>
							...
							<a href="tel:858-246-4777" class="text-blue-600 dark:text-blue-400 underline"
								>858-246-4777</a
							>
							{' • '}
							<a href="mailto:irb@ucsd.edu" class="text-blue-600 dark:text-blue-400 underline"
								>irb@ucsd.edu</a
							>
						</p>
					</div>
					...
					<div>
						...
						<p>
							We study how parents want to moderate their children's interactions with generative AI
							(e.g., ChatGPT). You are eligible because you are a parent or legal guardian of a
							child aged <strong>9–18</strong>.
						</p>
					</div>
					...
					<div>
						...
						<p>
							You will complete a <strong>web survey (~15–20 minutes)</strong> hosted in this app. You
							will see brief scenarios of children using AI and indicate how you would want the AI to
							respond or be moderated. You may answer a few open-ended questions and brief demographics.
						</p>
						<p class="mt-2">
							You <strong>may optionally repeat</strong> the survey
							<strong>once per day for up to 5 days</strong>; each day is a separate, voluntary
							session.
						</p>
					</div>
					...
					<div>
						...
						<ul class="list-disc list-inside space-y-1 ml-2">
							<li>
								Your survey responses and interactions in the tool (e.g., choices, typed text,
								timestamps).
							</li>
							<li>
								Your <strong>Prolific ID</strong> (passed via the URL) to manage payment and prevent duplicate
								entries.
							</li>
							<li>
								We <strong>do not</strong> ask for your name.
								<strong
									>Please do not include names or other identifying details about you or your child</strong
								> in any free-text responses.
							</li>
						</ul>
					</div>
					...
					<div>
						...
						<p>
							Risks are <strong>minimal</strong> (similar to everyday online questionnaires). Some scenarios
							may mention sensitive themes (e.g., violence, sex, self-harm) and could feel uncomfortable.
					...
					<div>
						...
						<p>
							You will not directly benefit. Findings may inform safer, more parent-aligned AI
							moderation tools.
						</p>
					</div>
					...
					<div>
						...
						<p>
							For each completed daily session, you will receive <strong>$4.00 base</strong> via
							Prolific. You <strong>may earn up to an additional $2.00 bonus</strong> for
							thoughtful, complete answers and engaged use of the moderation tool, as described on
							the study page. Each day's payment (base + any bonus) is processed
							<strong>separately</strong> via Prolific.
						</p>
					</div>
					...
					<div>
						...
						<p>
							We label study data with a code (not your name). We store data on secure UC San Diego
							systems and restrict access to the research team. We will report results in aggregate
							and may share <strong>de-identified</strong> data for research and publication. We retain
							data per UC San Diego policy and sponsor requirements.
						</p>
					</div>
					...
					<div>
						...
						<p>
							Participation is <strong>voluntary</strong>. You may decline or withdraw at any time
							without penalty or loss of benefits. If you choose <strong>not</strong> to
							participate, select <strong>"I Do Not Consent"</strong> to return to Prolific.
						</p>
					</div>
					...
					<div>
						...
						<p>
							You may request or retain a copy of this consent in non-electronic form. You may
							provide consent in non-electronic form. If you later withdraw your electronic consent,
							a copy of it will be kept for regulatory purposes.
						</p>
						<p class="mt-2">
							You can request a document version of this consent form and a receipt of your consent
							by emailing us at
							<a
								href="mailto:childai.research.ucsd@gmail.com"
								class="text-blue-600 dark:text-blue-400 underline"
