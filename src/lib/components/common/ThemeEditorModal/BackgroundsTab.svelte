...
<div class="space-y-4">
	<div>
		<div class="flex items-center gap-2">
			<Switch
				bind:state={themeCopy.toggles.gradient}
			...
			<Tooltip content="Adds a gradient to the background of the app.">
				<label
					...
					>{$i18n.t('System Gradient Background')}</label
				>
			</Tooltip>
		</div>
	...
	<div>
		<div class="flex items-center gap-2">
			...
			<Tooltip content="Adds a background image to the app.">
				<label
					for="theme-background-image"
					class="block text-sm font-medium text-gray-700 dark:text-gray-300"
					>{$i18n.t('System Background Image')}</label
				>
			</Tooltip>
		</div>
		{#if themeCopy.toggles.systemBackgroundImage}
			<div class="mt-1 space-y-2">
				<label
					for="theme-background-image-url"
					class="block text-sm font-medium text-gray-700 dark:text-gray-300"
					>{$i18n.t('Image URL')}</label
				>
				<div class="flex items-center gap-2">
					<input
						type="text"
				...
				<label
					for="theme-background-image-darken"
					class="block text-sm font-medium text-gray-700 dark:text-gray-300"
					>{$i18n.t('Darken')}: {themeCopy.systemBackgroundImageDarken}%</label
				>
				<input
					type="range"
	...
	<div>
		<div class="flex items-center gap-2">
			...
			<Tooltip content="Adds a background image to the chat.">
				<label
					for="theme-chat-background-image"
					class="block text-sm font-medium text-gray-700 dark:text-gray-300"
					>{$i18n.t('Chat Background Image')}</label
				>
			</Tooltip>
		</div>
		{#if themeCopy.toggles.chatBackgroundImage}
			<div class="mt-1 space-y-2">
				<label
					for="theme-chat-background-image-url"
					class="block text-sm font-medium text-gray-700 dark:text-gray-300"
					>{$i18n.t('Image URL')}</label
				>
				<div class="flex items-center gap-2">
				...
				<label
					for="theme-chat-background-image-darken"
					class="block text-sm font-medium text-gray-700 dark:text-gray-300"
					>{$i18n.t('Darken')}: {themeCopy.chatBackgroundImageDarken}%</label
				>
				<input
					type="range"
