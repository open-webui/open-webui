...
<div class="grid grid-cols-2 gap-4">
  ...
  <div>
    <label for="theme-description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{$i18n.t('Description')}</label>
  ...
  <div>
    <label for="theme-repo" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{$i18n.t('Repository URL')}</label>
  ...
  <div>
    <label for="theme-update-url" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{$i18n.t('Theme Update URL')}</label>
