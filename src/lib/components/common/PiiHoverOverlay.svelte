...
{#if visible && entity}
	...
	>
		...
		>
			<!-- Header -->
			<div
				class="px-3 py-2 border-b border-[#f8b76b]/30 dark:border-[#3f3d8a]/50 bg-gradient-to-r from-[#f8b76b]/10 to-[#f9c689]/20 dark:from-[#3f3d8a]/10 dark:to-[#3f3d8a]/20"
			>
				<div class="flex items-center justify-between">
					<div class="flex items-center gap-2">
						...
						<h3 class="font-medium text-sm text-[#3f3d8a] dark:text-[#f8b76b]">PII</h3>
					</div>
					<button
			...
			<div class="px-3 py-2 space-y-2">
				...
				<div class="space-y-1.5">
					<div class="flex items-center justify-between">
						...
						<span
							class="text-xs font-semibold text-[#3f3d8a] dark:text-white uppercase px-1.5 py-0.5 bg-[#f8b76b]/20 dark:bg-[#3f3d8a]/20 rounded"
						>
							{entity.type}
						</span>
					</div>
					...
					<div class="flex items-center justify-between">
						...
						<span
							class="text-xs text-[#3f3d8a] dark:text-white text-right break-all bg-[#f8b76b]/10 dark:bg-[#3f3d8a]/10 px-1.5 py-0.5 rounded italic max-w-32"
						>
							"{entity.raw_text}"
						</span>
					</div>
					...
					<div class="flex items-center justify-between">
						...
						<span
							class="text-xs font-mono text-[#3f3d8a] dark:text-white text-right break-all bg-[#f8b76b]/10 dark:bg-[#3f3d8a]/10 px-1.5 py-0.5 rounded font-semibold max-w-32"
						>
							[{`{${entity.label}}`}]
						</span>
					</div>
