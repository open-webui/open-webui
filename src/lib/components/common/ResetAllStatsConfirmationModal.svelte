...
<Modal bind:show on:close>
	<div class="p-4">
		...
		<div class="mt-4 flex justify-end space-x-2">
			...
			<button
				type="button"
				class="px-4 py-2 text-sm font-medium text-white bg-yellow-500 border border-transparent rounded-md hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 disabled:opacity-50"
