...
<div class="w-full px-12 py-10 flex justify-between items-center border-b border-gray-200 dark:border-gray-950 bg-gradient-to-l from-gray-50/50 to-gray-100/50 dark:from-gray-900 dark:to-gray-950  backdrop-blur-xl">
	<!-- Title and Subtitle Section (Left) -->
	<div class="flex flex-col justify-start gap-1 flex-1">
		{#if hasChapter}
			<h2 class="font-semibold pt-1 text-gray-900 dark:text-gray-100 leading-none text-title-4 mb-3 truncate">{title}</h2>
