							...
							>
								...
								<div class="px-2.5">
									{#if $settings?.richTextInput ?? true}
										<div
											class="scrollbar-hidden text-left fr-background-contrast--grey dark:text-gray-100 outline-none w-full rounded-md px-2 py-2 resize-none h-fit max-h-80 overflow-auto"
										>
											<RichTextInput
