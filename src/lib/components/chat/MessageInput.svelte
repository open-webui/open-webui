					...
					>
						...
						<div
							...
							class="flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border {$temporaryChatEnabled
								? 'border-dashed border-gray-100 dark:border-gray-800 hover:border-gray-200 focus-within:border-[var(--mws-red)] hover:dark:border-gray-700 focus-within:dark:border-[var(--mws-red)]'
								: ' border-gray-100/30 dark:border-gray-850/30 hover:border-gray-200 focus-within:border-[var(--mws-red)] hover:dark:border-gray-800 focus-within:dark:border-[var(--mws-red)]'}  transition px-1 bg-white/5 dark:bg-gray-500/5 backdrop-blur-sm dark:text-gray-100"
