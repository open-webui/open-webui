...
{#if loaded}
	<div class="w-full font-primary">
		...
		<div class="{transparentBackground ? 'bg-transparent' : 'bg-transparent'} ">
			<div
			...
			>
				<div class="">
					...
					{:else}
						...
						>
							<div
								class="flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border border-gray-50 dark:border-gray-850 hover:border-gray-100 focus-within:border-gray-100 hover:dark:border-gray-800 focus-within:dark:border-gray-800 transition px-1 bg-white/90 dark:bg-gray-400/5 dark:text-gray-100 message-input-container"
