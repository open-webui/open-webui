...
>
	...
	>
		<div
			class="flex w-full text-left px-0.5 outline-hidden bg-transparent truncate {triggerClassName} justify-between font-semibold placeholder-gray-400 focus:outline-hidden"
		>
			{#if selectedModel}
				{selectedModel.label}
			{:else}
