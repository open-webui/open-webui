	...
	<div class="py-1 overflow-y-scroll max-h-[28rem] md:max-h-full">
		<div>
			<div class="flex items-center justify-between mb-1">
				<Tooltip
					content={$i18n.t(
						'Memory is difficult so this is an experimental feature, it may not function as expected and is subject to change at any time.'
					)}
				>
		...
		<div class="text-xs text-gray-600 dark:text-gray-400">
			<div>
				{$i18n.t(
					"Turn this on to let Alyx remember and recall things about you automatically between chats, you can manage what it sees using the button below"
				)}
			</div>
