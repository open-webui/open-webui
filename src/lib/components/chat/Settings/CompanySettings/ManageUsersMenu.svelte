<script lang="ts">
	...
	>
		...
		{#if showDropdown}
			<div
				class="min-w-[18rem] flex flex-col absolute left-0 right-0 bg-white dark:bg-customGray-800 px-2 py-2 border border-gray-300 dark:border-customGray-700 rounded-lg z-10"
			>
            <div class=flex>
                <div class="flex border dark:border-customGray-700 rounded-lg dark:bg-customGray-900 dark:text-customGray-200">
                ...
                <button type="button" class="flex items-center shrink-0 ml-2.5 font-medium dark:text-white">
            ...
            <div class="mt-2 max-h-[180px] overflow-y-auto pr-1">
                {#each filteredUsers as user}
                    ...
                    }} class="w-full flex items-center p-1 hover:dark:bg-customGray-900 rounded-lg cursor-pointer">
                        <img
