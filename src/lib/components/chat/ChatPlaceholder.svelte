...
{#key mounted}
	<div class="m-auto w-full max-w-6xl px-8 lg:px-20 -mt-16">
		...
		>
			<div>
				<div class=" capitalize line-clamp-1" in:fade={{ duration: 200 }} style="font-family: 'Cambria', 'Times New Roman', serif;">
