			...
			<div class="w-full flex flex-col items-center">
				{#if $temporaryChatEnabled}
					<Tooltip
						...
						className="w-full @md:max-w-3xl flex justify-center mb-0.5"
						placement="top"
					>
				...
				<div class="mt-2 w-full @md:max-w-3xl" in:fade={{ duration: 200 }}>
					<FolderTitle
				...
				<div
					class="w-full @md:max-w-3xl px-6 font-primary min-h-62"
