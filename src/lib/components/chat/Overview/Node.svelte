...
>
	...
	<Handle class="w-2 rounded-full dark:bg-gray-900" position={Position.Top} type="target" />
	<Handle class="w-2 rounded-full dark:bg-gray-900" position={Position.Bottom} type="source" />
</div>
