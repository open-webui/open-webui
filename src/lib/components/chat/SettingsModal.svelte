<script lang="ts">
    ...
    import Shortcuts from './Settings/Shortcuts.svelte'; // Added import
        ...
        <div class="flex flex-col md:flex-row w-full px-4 pt-1 pb-4 md:space-x-4">
                        ...
                        {:else if tabId === 'audio'}
                            ...
                            <div class="self-center mr-2">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 5C0 3.34315 1.34315 2 3 2H21C22.6569 2 24 3.34315 24 5V19C24 20.6569 22.6569 22 21 22H3C1.34315 22 0 20.6569 0 19V5ZM3 4H21C21.5523 4 22 4.44772 22 5V19C22 19.5523 21.5523 20 21 20H3C2.44772 20 2 19.5523 2 19V5C2 4.44772 2.44771 4 3 4Z" fill="currentColor"></path>
                                </svg>
                            </div>
                                <div class="self-center">{$i18n.t('Shortcuts')}</div>
                            </button>
                        {:else if tabId === 'chats'}
                            <button
                                class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
            ...
            <div class="flex-1 md:min-h-[32rem] max-h-[32rem]">
                ...
                {:else if selectedTab === 'audio'}
                    ...
                    />
                {:else if selectedTab === 'shortcuts'} <Shortcuts
                        {saveSettings}
                        on:save={() => {
                            toast.success($i18n.t('Settings saved successfully!'));
                        }}
