...
>
	...
	<div slot="content">
		...
		>
			...
			>
				<DropdownMenu.Item
					class="flex gap-2 items-center px-3 py-2 text-2xs  dark:text-customGray-100 font-medium cursor-pointer hover:bg-gray-50 dark:hover:bg-customGray-950  rounded-lg {!fileUploadEnabled
						? 'opacity-50'
						: ''}"
					on:click={() => {
