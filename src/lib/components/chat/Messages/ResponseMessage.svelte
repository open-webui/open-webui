	...
	>
		...
		<div class="w-full overflow-hidden pl-1">
			...
			<div>
				...
				<div
					class="prose chat-{message.role} w-full max-w-full dark:prose-invert prose-p:my-0 prose-img:my-1 prose-headings:my-1.5 prose-pre:my-0 prose-table:my-0 prose-blockquote:my-0 prose-ul:-my-1.5 prose-ol:-my-1.5 prose-li:-my-2.5 whitespace-pre-line"
				>
					<div>
