		...
		<div class=" flex w-full space-x-2">
			...
			<div>
				{#if $user?.role === 'admin'}
					...
					>
						<div
							class="w-9 h-9 rounded-full bg-gray-200/70 dark:bg-gray-700/70 hover:bg-gray-200 dark:hover:bg-gray-700 dark:text-gray-300 dark:hover:text-white transition font-medium text-sm flex items-center justify-center"
						>
