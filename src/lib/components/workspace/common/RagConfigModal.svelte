<script>
    ...
    let rerankingModel = RAGConfig.reranking_model || "";
    ...
    rerankingModel = RAGConfig.reranking_model || "";
    ...
    const setRerankingConfig = async () => {
        ...
        const rerankingConfig = await getRerankingConfig(localStorage.token, {knowledge_id: knowledgeId});
