...
<div>
	<div class="flex w-full justify-between mb-1">
		<div class=" self-center text-base font-semibold">{$i18n.t('Knowledge')}</div>
	</div>
	...
	<div class="flex flex-col">
		...
		<div class="flex flex-wrap text-sm font-medium gap-1.5 mt-2">
			...
			>
				<button
					class=" px-3.5 py-1.5 font-medium hover:bg-black/5 dark:hover:bg-white/5 outline outline-1 outline-gray-100 dark:outline-gray-850 rounded-lg"
