...
<div class="flex-1 w-full h-full flex justify-center" id="note-editor">
	...
	<a href="/notes" class="items-center mb-[17px] ml-[12px] flex gap-[4px] text-neutrals-800 text-[14px] leading-[22px] font-bold"><ArrowLeftNew/>back</a>
