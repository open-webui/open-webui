					...
					{#each Object.keys(notes) as timeRange}
						...
						<div class="gap-[12px] grid grid-cols-3 sm:grid-cols-1">
							{#each notes[timeRange] as note, idx (note.id)}
										<div
									class=" flex cursor-pointer w-full p-[16px] mb-[12px] bg-white/88 dark:bg-gray-850 dark:hover:bg-white/5 hover:bg-black/5 rounded-[12px] transition rounded-[12px] bg-white/90 backdrop-blur-[12px]"
								>
