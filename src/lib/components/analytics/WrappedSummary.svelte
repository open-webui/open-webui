...
<div class="w-full">
	{#if loading}
		<div class="flex items-center justify-center py-24">
			<div class="flex flex-col items-center gap-4">
				<div
					class="w-16 h-16 border-4 border-[#00ff41] border-t-transparent rounded-full animate-spin"
				></div>
	...
	{:else if wrapped}
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
			<!-- Total Tokens -->
			<div
				class="group relative bg-black border border-white/20 p-6 hover:border-[#00ff41] transition-colors overflow-hidden"
			>
				<div
				...
				<div
					class="text-4xl md:text-5xl font-bold text-white group-hover:text-[#00ff41] transition-colors font-['Koulen']"
				>
					{formatTokenCount(wrapped.total_tokens)}
				</div>
				<div class="mt-4 h-1 w-full bg-white/10">
					<div
						class="h-full bg-[#00ff41] w-full origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"
					></div>
				</div>
			</div>
			...
			>
				...
				<div class="mt-4 h-1 w-full bg-white/10">
					<div
						class="h-full bg-[#00ff41] w-full origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 delay-75"
					></div>
				</div>
			</div>
			...
			>
				...
				<div class="mt-4 h-1 w-full bg-white/10">
					<div
						class="h-full bg-[#00ff41] w-full origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 delay-150"
					></div>
				</div>
			</div>
			...
			>
				...
				<div class="mt-4 h-1 w-full bg-white/10">
					<div
						class="h-full bg-[#00ff41] w-full origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 delay-200"
					></div>
				</div>
			</div>
		</div>
					...
					<div class="group">
						...
						<div class="h-4 bg-white/5 w-full overflow-hidden relative">
							...
							<div
								...
								style="background-image: linear-gradient(90deg, transparent 98%, rgba(0,0,0,0.5) 98%); background-size: 2% 100%;"
							></div>
							<div
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
			...
			{#if wrapped.most_active_day}
				<div class="relative group">
					<div
						class="absolute -inset-0.5 bg-gradient-to-r from-orange-600 to-red-600 opacity-20 group-hover:opacity-100 transition duration-500 blur"
					></div>
			...
			{#if wrapped.favorite_model}
				<div class="relative group">
					<div
						class="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-pink-600 opacity-20 group-hover:opacity-100 transition duration-500 blur"
					></div>
					<div class="relative bg-black border border-white/10 p-8 h-full">
						<div class="flex items-start justify-between mb-6">
							<div>
