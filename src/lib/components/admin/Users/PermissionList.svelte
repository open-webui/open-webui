...
<div class="scrollbar-hidden relative whitespace-nowrap overflow-x-auto max-w-full rounded-sm pt-0.5">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 table-auto max-w-full rounded-sm">
        ...
        <tr class="">
            <th scope="col" class="px-3 py-1.5 cursor-pointer select-none" on:click={() => setSortKey('id')}>
            ...
            <th scope="col" class="px-3 py-1.5 cursor-pointer select-none" on:click={() => setSortKey('category')}>
                <div class="flex gap-1.5 items-center">
                    {$i18n.t('Category')}
            ...
            <th scope="col" class="px-3 py-1.5 cursor-pointer select-none" on:click={() => setSortKey('name')}>
                <div class="flex gap-1.5 items-center">
                    {$i18n.t('Name')}
            ...
            <th scope="col" class="px-3 py-1.5 cursor-pointer select-none" on:click={() => setSortKey('label')}>
                <div class="flex gap-1.5 items-center">
                    {$i18n.t('Label')}
                    {#if sortKey === 'label'}
							<span class="font-normal"
            ...
            <th scope="col" class="px-3 py-1.5 cursor-pointer select-none" on:click={() => setSortKey('description')}>
                <div class="flex gap-1.5 items-center">
                    {$i18n.t('Description')}
