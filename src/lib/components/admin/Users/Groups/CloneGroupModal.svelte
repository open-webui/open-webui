				...
				>
                    <div class="flex flex-col space-y-4">
                        <div class="flex flex-col">
                            <label for="group-name" class="text-sm font-medium">{$i18n.t('Group Name')}</label>
                            <input
                                id="group-name"
                                type="text"
                        ...
                        <div class="flex flex-col space-y-2">
                            <label class="text-sm font-medium">{$i18n.t('Clone Options')}</label>
                            <Checkbox bind:checked={clone_members} label={$i18n.t('Clone group members')} />
                            <Checkbox bind:checked={clone_settings} label={$i18n.t('Clone group settings')} />
                        </div>
                    </div>
