				...
				<div class="space-y-1">
					<div class="flex gap-2">
						<div class="flex-1">
							...
							>
								<option class="bg-gray-100 dark:bg-gray-700" disabled selected value=""
									>{$i18n.t('Select a pipeline url')}</option
								>

								{#each PIPELINES_LIST as pipelines, idx}
									<option class="bg-gray-100 dark:bg-gray-700" value={pipelines.idx.toString()}
									...
									<div class="flex-1">
										...
										>
											{#each pipelines as pipeline, idx}
												<option class="bg-gray-100 dark:bg-gray-700" value={idx}
