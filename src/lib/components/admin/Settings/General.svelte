						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									...
									{#if $config?.features?.enable_version_update_check}
										<a
											href="https://github.com/BEKO2210/privatedesk-ai/releases/tag/v{version.latest}"
											target="_blank"
										>
											{updateAvailable === null
					...
					<div class="mb-2.5">
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use PrivateDesk AI and get support.')}
								</div>
							</div>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								<a href="mailto:belkis.aslani@gmail.com" target="_blank">
									<img
										alt="Discord"
										src="https://img.shields.io/badge/Support-PrivateDesk_AI-blue"
									/>
								</a>
								...
								<a href="mailto:belkis.aslani@gmail.com" target="_blank">
									<img
										...
										src="https://img.shields.io/badge/Contact-Support-green"
									/>
								</a>

								<a href="https://github.com/BEKO2210/privatedesk-ai" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/BEKO2210/privatedesk-ai?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a
										href="mailto:belkis.aslani@gmail.comenterprise"
										target="_blank"
						...
						{#if adminConfig?.ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2 mb-2.5">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<a
										href="mailto:belkis.aslani@gmail.comreference/api-endpoints"
										target="_blank"
							...
							<div class="mt-2 text-xs">
								...
								>
									<div>
										...
										<span
											><a
												href="mailto:belkis.aslani@gmail.comreference/env-configuration#jwt_expires_in"
												target="_blank"
												class=" underline"
