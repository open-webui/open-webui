		...
		{#if adminConfig !== null}
			<div class="">
				<div class="mb-3.5">
					...
					<div class="mb-2.5">
						<div class=" mb-1 text-sm font-medium flex space-x-2 items-center">
							<div>
								{$i18n.t('Version')}
							</div>
						</div>
						<div class="flex w-full justify-between items-center">
							...
							<!-- <button
								class=" text-sm px-3 py-1.5 bg-gray-50 hover:bg-gray-100 dark:bg-gray-850 dark:hover:bg-gray-800 transition rounded-lg font-medium"
								type="button"
								on:click={() => {
									checkForVersionUpdates();
								}}
					...
					<!-- <div class="mb-2.5">
						<div class="flex w-full justify-between items-center">
							...
							<a
								class="flex-shrink-0 text-sm font-medium underline"
					...
					<!-- <div class="mb-2.5">
						<div class="flex w-full justify-between items-center">
							...
							<button
								class="flex-shrink-0 text-sm px-3 py-1.5 bg-gray-50 hover:bg-gray-100 dark:bg-gray-850 dark:hover:bg-gray-800 transition rounded-lg font-medium"
							>
								{$i18n.t('Activate')}
							</button>
						</div>
				...
				<div class="mb-3">
					...
					<div class="  mb-2.5 flex w-full justify-between">
						<div class=" self-center text-sm font-medium">{$i18n.t('Default User Role')}</div>
					...
					<div class=" mb-2.5 flex w-full justify-between pr-2">
						<div class=" self-center text-sm font-medium">{$i18n.t('Enable New Sign Ups')}</div>
					...
					<div class="mb-2.5 flex w-full justify-between pr-2">
						<div class=" self-center text-sm font-medium">{$i18n.t('Enable API Key')}</div>
					...
					<div class=" mb-2.5 w-full justify-between">
						<div class="flex w-full justify-between">
							<div class=" self-center text-sm font-medium">{$i18n.t('JWT Expiration')}</div>
						</div>
							...
							{#if ENABLE_LDAP}
								<div class="flex flex-col gap-1">
									<div class="flex w-full gap-2">
										<div class="w-full">
											<div class=" self-center text-sm font-medium min-w-fit mb-1">
												{$i18n.t('Label')}
											</div>
											<input
									...
									<div>
										...
										{#if LDAP_SERVER.use_tls}
											<div class="flex w-full gap-2">
												<div class="w-full">
													<div class=" self-center text-sm font-medium min-w-fit mb-1 mt-1">
				...
				<div class="mb-3">
					...
					<div class="mb-2.5 flex w-full items-center justify-between pr-2">
						<div class=" self-center text-sm font-medium">{$i18n.t('Enable Message Rating')}</div>
					...
					<div class="mb-2.5 w-full justify-between">
						<div class="flex w-full justify-between">
							<div class=" self-center text-sm font-medium">{$i18n.t('WebUI URL')}</div>
						</div>
					...
					<div class=" w-full justify-between">
						<div class="flex w-full justify-between">
							<div class=" self-center text-sm font-medium">{$i18n.t('Webhook URL')}</div>
						</div>
