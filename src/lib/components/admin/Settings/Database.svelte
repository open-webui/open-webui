<script lang="ts">
	...
	import { downloadOpenWebUiLog, downloadFlaskLog } from '../../chat/Controls/Controls.svelte';

	const i18n = getContext('i18n');

	export let saveHandler: Function;

	let downloadingOpenWebUi = false;
	let downloadingFlask = false;
			...
			{#if $config?.features.enable_admin_export ?? true}
				...
				<div class="  flex w-full justify-between">
					...
					>
						...
						<div class=" self-center text-sm font-medium">
							{$i18n.t('Download Open Web UI log')}
						</div>
					</button>
				</div>
				<div class="  flex w-full justify-between">
