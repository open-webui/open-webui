...
<div class="bg-white dark:bg-gray-850 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
	...
	{:else if loading}
		<div class="flex items-center justify-center py-8">
			...
			<span class="ml-2 text-sm text-gray-600 dark:text-gray-400">{$i18n.t('Loading user data...')}</span>
		</div>
	...
	{:else}
		<p class="text-sm text-gray-500 dark:text-gray-400 text-center py-8">
			{$i18n.t('No user usage data available for this period.')}
		</p>
	{/if}
</div>