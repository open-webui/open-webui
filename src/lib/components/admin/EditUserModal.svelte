...
<Modal size="sm" bind:show>
	<div>
		...
		on:submit|preventDefault={() => {
			...
			<div class="flex flex-col md:flex-row w-full p-5 md:space-x-4 dark:text-gray-200 overflow-y-scroll max-h-96">
			...
			<div class="flex justify-end pt-3 text-sm font-medium m-4">
				<button
