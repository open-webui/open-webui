...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
	...
	>
		<button
			id="general"
			class="vertical-tab px-0.5 py-1 min-w-fit flex-1 lg:flex-none flex text-right transition {selectedTab ===
			'general'
				? ''
		...
		<button
			id="connections"
			class="vertical-tab px-0.5 py-1 min-w-fit flex-1 md:flex-none flex text-left transition {selectedTab ===
			'connections'
				? ''
				: ' text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'}"
			on:click={() => {
