	...
	>
		...
		<div class="w-full group">
			<button
				...
				class="relative w-full py-1.5 px-2 rounded-md flex items-center gap-1.5 text-xs text-gray-100 dark:text-gray-500 dark:text-gray-500 font-medium hover:bg-[#8900E1] dark:hover:bg-gray-700 transition"
				on:dblclick={() => {
					editHandler();
				}}
			>
