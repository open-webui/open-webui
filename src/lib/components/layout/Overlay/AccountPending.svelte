		...
		<div class="m-auto pb-10 flex flex-col justify-center">
			<div class="max-w-md">
				...
				<div class=" mt-4 text-center text-sm dark:text-gray-200 w-full">
					...
					To access the ContextOps AI Platform, please reach out our
					<a
						href="https://discord.gg/RNa7nds8"
						class="inline-flex items-center justify-center px-2 py-1 text-base font-medium text-center text-black border border-black rounded-lg bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 lg:ml-2"
					>
						Discord
						<svg
