...
>
	...
	>
		...
		<div class="flex items-center justify-center space-x-3 py-2 mb-3">
			<img src="http://localhost:8080/static/Logo-Alest-Branco-240x104-1-1.png" alt="Alest" class="h-5 w-auto" />
			<img src="http://localhost:8080/static/logo-gol.svg" alt="GOL" class="h-5 w-auto" />
		</div>
