...
export const createNewFunction = async (token: string, func: object) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/create`, {
		method: 'POST',
		headers: {
...
export const getFunctions = async (token: string = '') => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const exportFunctions = async (token: string = '') => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/export`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFunctionById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFunctionById = async (token: string, id: string, func: object) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteFunctionById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const toggleFunctionById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/toggle`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const toggleGlobalById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/toggle/global`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFunctionValvesById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/valves`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFunctionValvesSpecById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/valves/spec`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFunctionValvesById = async (token: string, id: string, valves: object) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/valves/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getUserValvesById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/valves/user`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getUserValvesSpecById = async (token: string, id: string) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/valves/user/spec`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateUserValvesById = async (token: string, id: string, valves: object) => {
	...
	const res = await fetch(`${Falcor_API_BASE_URL}/functions/id/${id}/valves/user/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
