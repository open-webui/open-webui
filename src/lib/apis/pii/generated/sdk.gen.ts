...
import type { HealthCheckHealthGetData, HealthCheckHealthGetResponses, CacheHealthCheckHealthCacheGetData, CacheHealthCheckHealthCacheGetResponses, CreateSessionSessionsPostData, CreateSessionSessionsPostResponses, CreateSessionSessionsPostErrors, DeleteSessionSessionsSessionIdDeleteData, DeleteSessionSessionsSessionIdDeleteResponses, DeleteSessionSessionsSessionIdDeleteErrors, GetSessionSessionsSessionIdGetData, GetSessionSessionsSessionIdGetResponses, GetSessionSessionsSessionIdGetErrors, MaskTextTextMaskPostData, MaskTextTextMaskPostResponses, MaskTextTextMaskPostErrors, UnmaskTextTextUnmaskPostData, UnmaskTextTextUnmaskPostResponses, UnmaskTextTextUnmaskPostErrors, MaskFileFileMaskPostData, MaskFileFileMaskPostResponses, MaskFileFileMaskPostErrors, GetTaskProgressFileMaskTaskTaskIdGetData, GetTaskProgressFileMaskTaskTaskIdGetResponses, GetTaskProgressFileMaskTaskTaskIdGetErrors, MaskTextWithSessionSessionsSessionIdTextMaskPostData, MaskTextWithSessionSessionsSessionIdTextMaskPostResponses, MaskTextWithSessionSessionsSessionIdTextMaskPostErrors, UnmaskTextWithSessionSessionsSessionIdTextUnmaskPostData, UnmaskTextWithSessionSessionsSessionIdTextUnmaskPostResponses, UnmaskTextWithSessionSessionsSessionIdTextUnmaskPostErrors, MaskFileWithSessionSessionsSessionIdFileMaskPostData, MaskFileWithSessionSessionsSessionIdFileMaskPostResponses, MaskFileWithSessionSessionsSessionIdFileMaskPostErrors, RedocHtmlRedocGetData, RedocHtmlRedocGetResponses, DocsHtmlDocsGetData, DocsHtmlDocsGetResponses } from './types.gen';
 ...
 */
export const cacheHealthCheckHealthCacheGet = <ThrowOnError extends boolean = false>(options?: Options<CacheHealthCheckHealthCacheGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<CacheHealthCheckHealthCacheGetResponses, unknown, ThrowOnError>({
        url: '/health/cache',
        ...options
    });
};
...
export const createSessionSessionsPost = <ThrowOnError extends boolean = false>(options: Options<CreateSessionSessionsPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateSessionSessionsPostResponses, CreateSessionSessionsPostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
...
export const deleteSessionSessionsSessionIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteSessionSessionsSessionIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteSessionSessionsSessionIdDeleteResponses, DeleteSessionSessionsSessionIdDeleteErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 */
export const getSessionSessionsSessionIdGet = <ThrowOnError extends boolean = false>(options: Options<GetSessionSessionsSessionIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetSessionSessionsSessionIdGetResponses, GetSessionSessionsSessionIdGetErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 * ```
 */
export const maskTextTextMaskPost = <ThrowOnError extends boolean = false>(options: Options<MaskTextTextMaskPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MaskTextTextMaskPostResponses, MaskTextTextMaskPostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 * ```
 */
export const unmaskTextTextUnmaskPost = <ThrowOnError extends boolean = false>(options: Options<UnmaskTextTextUnmaskPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UnmaskTextTextUnmaskPostResponses, UnmaskTextTextUnmaskPostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 * ```
 */
export const maskFileFileMaskPost = <ThrowOnError extends boolean = false>(options: Options<MaskFileFileMaskPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MaskFileFileMaskPostResponses, MaskFileFileMaskPostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 * ```
 */
export const getTaskProgressFileMaskTaskTaskIdGet = <ThrowOnError extends boolean = false>(options: Options<GetTaskProgressFileMaskTaskTaskIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetTaskProgressFileMaskTaskTaskIdGetResponses, GetTaskProgressFileMaskTaskTaskIdGetErrors, ThrowOnError>({
 ...
 */
export const maskTextWithSessionSessionsSessionIdTextMaskPost = <ThrowOnError extends boolean = false>(options: Options<MaskTextWithSessionSessionsSessionIdTextMaskPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MaskTextWithSessionSessionsSessionIdTextMaskPostResponses, MaskTextWithSessionSessionsSessionIdTextMaskPostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 */
export const unmaskTextWithSessionSessionsSessionIdTextUnmaskPost = <ThrowOnError extends boolean = false>(options: Options<UnmaskTextWithSessionSessionsSessionIdTextUnmaskPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UnmaskTextWithSessionSessionsSessionIdTextUnmaskPostResponses, UnmaskTextWithSessionSessionsSessionIdTextUnmaskPostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 */
export const maskFileWithSessionSessionsSessionIdFileMaskPost = <ThrowOnError extends boolean = false>(options: Options<MaskFileWithSessionSessionsSessionIdFileMaskPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<MaskFileWithSessionSessionsSessionIdFileMaskPostResponses, MaskFileWithSessionSessionsSessionIdFileMaskPostErrors, ThrowOnError>({
        security: [
            {
                name: 'X-API-Key',
                type: 'apiKey'
 ...
 * Redoc Html
 */
export const redocHtmlRedocGet = <ThrowOnError extends boolean = false>(options?: Options<RedocHtmlRedocGetData, ThrowOnError>) => {
 ...
 * Docs Html
 */
export const docsHtmlDocsGet = <ThrowOnError extends boolean = false>(options?: Options<DocsHtmlDocsGetData, ThrowOnError>) => {
