...
export const getToolServerUserConfigSpec = async (token: string, serverId: string) => {
	let error = null;

	const res = await fetch(
		`${WEBUI_API_BASE_URL}/tools/servers/${encodeURIComponent(serverId)}/user_config/spec`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getToolServerUserConfig = async (token: string, serverId: string) => {
	let error = null;

	const res = await fetch(
		`${WEBUI_API_BASE_URL}/tools/servers/${encodeURIComponent(serverId)}/user_config`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const updateToolServerUserConfig = async (
	token: string,
	serverId: string,
	config: object
) => {
	...
	const res = await fetch(
		`${WEBUI_API_BASE_URL}/tools/servers/${encodeURIComponent(serverId)}/user_config/update`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
...
export const deleteToolServerUserConfig = async (token: string, serverId: string) => {
	let error = null;
