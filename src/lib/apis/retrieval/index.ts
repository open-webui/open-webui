...
export const queryDoc = async (
    ...
    const res = await fetch(`${RETRIEVAL_API_BASE_URL}/query/doc`, {
        ...
        .catch((err) => {
            error = err.detail;
            console.error('Error in queryDoc:', err); // Log error specifically
            return null;
        });
...
export const queryCollection = async (
    ...
    const res = await fetch(`${RETRIEVAL_API_BASE_URL}/query/collection`, {
        ...
        .catch((err) => {
            error = err.detail;
            console.error('Error in queryCollection:', err); // Log error specifically
            return null;
        });
...
export const resetUploadDir = async (token: string) => {
    ...
    const res = await fetch(`${RETRIEVAL_API_BASE_URL}/reset/uploads`, {
        ...
        .catch((err) => {
            error = err.detail;
            console.error('Error in resetUploadDir:', err); // Log error specifically
            return null;
        });
...
export const resetVectorDB = async (token: string) => {
    ...
    const res = await fetch(`${RETRIEVAL_API_BASE_URL}/reset/db`, {
        ...
        .catch((err) => {
            error = err.detail;
            console.error('Error in resetVectorDB:', err); // Log error specifically
            return null;
        });
