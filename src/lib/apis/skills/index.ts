...
export const createNewSkill = async (token: string, skill: SkillItem) => {
	let error = null;
...
export const syncExternalSkills = async (token: string = '') => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/skills/sync/external`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateSkillById = async (token: string, id: string, skill: SkillItem) => {
	let error = null;
